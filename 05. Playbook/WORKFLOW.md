...
- Active universe: XAUUSD và bảy FX majors trong `01. GOAL/GOAL.md`.
...
- backtest 2018→latest khi data cho phép;
- mỗi XAU/FX sleeve có report và verdict riêng;
