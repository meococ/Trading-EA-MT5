#!/usr/bin/env python3
"""Build HYP-SPARK-ASIAN-M15-001 contract receipt matching alpha.ps1 NOGIT provenance."""
import hashlib
import json
...
prereg = root / "03. EA Developer/EA_SonicR/research/preregs/20260714_H_SPARK_ASIAN_M15_001_PREREG.md"
stub_dir = root / "03. EA Developer/EA_SonicR/research/preflight/spark_asian_m15/contracts/receipt_stubs_HYP_SPARK_ASIAN_M15_001"
...
include_records = []
for item in sorted(
    include_items, key=lambda x: str(Path(x["path"]).resolve()).lower()
):
...
receipt = {
    ...
    "note": "Model 0 control screen for Spark Asian M15. Binding must match alpha.ps1 invocation. Cost provenance unverified. Not Chop/VolExp/TickVol/HourOpen/InsideBar/GoldJPY rescue.",
}
receipt_path = contracts / "20260714_HYP_SPARK_ASIAN_M15_001_CONTRACT_RECEIPT.json"
receipt_path.write_text(json.dumps(receipt, indent=2) + "\n", encoding="utf-8")
receipt_sha = sha256_file(receipt_path)
print("RECEIPT", receipt_path)
print("RECEIPT_SHA256", receipt_sha)
print("SOURCE_SHA256", evidence[1]["sha256"])
(contracts / "20260714_HYP_SPARK_ASIAN_M15_001_CONTRACT_RECEIPT.sha256.txt").write_text(
    receipt_sha + "\n", encoding="utf-8"
)
