#!/usr/bin/env python3
"""Build HYP-INSIDEBAR-M15-001 contract receipt matching alpha.ps1 NOGIT provenance."""
import hashlib
import json
...
ea = root / "03. EA Developer/EA_M15InsideBreak/EA_M15InsideBreak.mq5"
agents = root / "AGENTS.md"
goal = root / "01. GOAL/GOAL.md"
prereg = root / "03. EA Developer/EA_SonicR/research/preregs/20260714_H_INSIDEBAR_M15_001_PREREG.md"
stub_dir = root / "03. EA Developer/EA_SonicR/research/preflight/insidebar_m15/contracts/receipt_stubs_HYP_INSIDEBAR_M15_001"
...
task_packet = {
    ...
    "hypothesis_id": "HYP-INSIDEBAR-M15-001",
    "ea_name": "EA_M15InsideBreak",
    "symbol": "USDJPY",
    "period": "M15",
    "from": "2021.01.01",
    "to": "2025.12.31",
...
(stub_dir / "include_note.txt").write_text(
    "EA_M15InsideBreak is single-file; Trade.mqh is MT5 standard library. "
...
receipt = {
    ...
    "note": "Model 0 control screen for InsideBar M15. Binding must match alpha.ps1 invocation. Cost provenance unverified. Not Chop/VolExp/TickVol/HourOpen/SB Friday rescue.",
}
receipt_path = contracts / "20260714_HYP_INSIDEBAR_M15_001_CONTRACT_RECEIPT.json"
receipt_path.write_text(json.dumps(receipt, indent=2) + "\n", encoding="utf-8")
receipt_sha = sha256_file(receipt_path)
print("RECEIPT", receipt_path)
print("RECEIPT_SHA256", receipt_sha)
print("SOURCE_SHA256", evidence[1]["sha256"])
(contracts / "20260714_HYP_INSIDEBAR_M15_001_CONTRACT_RECEIPT.sha256.txt").write_text(
    receipt_sha + "\n", encoding="utf-8"
)
