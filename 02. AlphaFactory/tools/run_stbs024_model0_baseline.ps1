...
$hyp024NonRepaintAuditorSha256 = "366D70F0C6FAF02F85B4819E7305CD1BD271BA6A78B4789CF0DCDF2FB651E360"
$hyp024StaticNonRepaintManifestPath = Join-Path $repoRoot "03. EA Developer\EA_SupertrendBurstScalperTradeV11\HYP-STBS-XAUUSD-M15-024_NONREPAINT_MANIFEST.json"
$hyp024StaticNonRepaintManifestSha256 = "DB83B722461F96F39133F54A812B6416DC7F2F5482353550EE254D409F453928"
$hyp024StaticNonRepaintAuditPath = Join-Path $repoRoot "03. EA Developer\EA_SupertrendBurstScalperTradeV11\research\HYP-STBS-XAUUSD-M15-024_NONREPAINT_AUDIT.json"
$hyp024StaticNonRepaintAuditSha256 = "52DE4406064F7C5586EAA3603F910C684C6E629B6B37CE1416F2BCDE67A1A439"
$hyp024SourceSha256 = "7CC7A9D7C30216A1669D84AEEA867E32EA15F2E9E8C195D171BD574A4D2EB0BC"
$hyp024ReservedPostPacketReviewRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/HYP-STBS-XAUUSD-M15-024_POST_PACKET_REVIEW.md"
$hyp024ReservedPostPacketReviewPlaceholderSha256 = "A492ED6A74E26B3E606A78E3361C87C97575271A09AA32CF0AB1A0586BFD4EC5"
$hyp024ReservedPostPacketReviewStatusLine = '?? "03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/HYP-STBS-XAUUSD-M15-024_POST_PACKET_REVIEW.md"'
$hyp024ParentTerminalRowSha256 = "2CA6AD8D565F0670E18DFBD58EA17CEE93372B18D1F06C27216288E49D6FA6B3"
$hyp024ParentTerminalVerdict = "KILL_ENGINEERING_JOURNAL_DELTA_TRUNCATED_UNTYPED_POST_MT5_NO_ECONOMIC_VERDICT"
$hyp024ParentFailurePacketRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV10/research/HYP-STBS-XAUUSD-M15-023_FAILURE_PACKET.json"
$hyp024ParentFailurePacketSha256 = "7A70CAAC8421B158D26CAD074BC81EBAABFD457B11717845FF04DA524AA319A8"
$hyp024ParentFailureReviewRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV10/research/HYP-STBS-XAUUSD-M15-023_POST_FAILURE_REVIEW.md"
$hyp024ParentFailureReviewSha256 = "5906FE93BAE9FA6C700F57D1DC490F0C4FA319276E6D2DED9AA8667A6A7F6FC5"
$hyp024TesterProjectionRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV10/research/evidence/HYP-STBS-XAUUSD-M15-023/STBS023-FAILURE-CLOSE-001/tester_hyp023_no_spam_projection.utf16le.log"
$hyp024TesterProjectionSha256 = "DDE409FE80DE6687DD0A520D0B4EAD2F20817142C212CD40E9E7FAFB2CC4EC7B"
$hyp024TesterProjectionBytes = 871692L
$hyp024AgentProjectionRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV10/research/evidence/HYP-STBS-XAUUSD-M15-023/STBS023-FAILURE-CLOSE-001/agent_hyp023_no_spam_projection.utf16le.log"
$hyp024AgentProjectionSha256 = "2F08B3860EB6247BF168331914754650548155FFC93513FD51FA539369BCE7AF"
$hyp024AgentProjectionBytes = 858852L
$hyp024JournalBudgetAddendumRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/HYP-STBS-XAUUSD-M15-024_JOURNAL_BUDGET_ADDENDUM.md"
$hyp024JournalBudgetAddendumSha256 = "C0AD425D1F368A41FE740E3EC22D1CF823F088005848BF14789C6EFFDD3AEF21"
$hyp024BoundedDiffProofRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/HYP-STBS-XAUUSD-M15-024_V10_V11_TELEMETRY_DIFF_PROOF.md"
$hyp024BoundedDiffProofSha256 = "0B95D49C9D2234ED790E6E09F8AF800C809B499B5366CB451CDD26EDC7732F34"
$hyp024CompactTelemetryTestRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/tests/test_stbs024_compact_telemetry_contract.py"
$hyp024CompactTelemetryTestSha256 = "C6CB1D4CE000DF09B8478E1A64FA30542E5D38E5AF84C834A6834FD2EE5A4CB0"
$hyp024CopyTimeLine = 678
...
function Add-Model0EconomicLaunchAuthorityBlockers(
    ...
    foreach ($boundControl in @(
        ...
        [pscustomobject]@{ PathField = 'reviewed_nonrepaint_auditor_path'; ShaField = 'reviewed_nonrepaint_auditor_sha256'; Label = 'HYP024 non-repaint auditor' },
        [pscustomobject]@{ PathField = 'reviewed_static_nonrepaint_manifest_path'; ShaField = 'reviewed_static_nonrepaint_manifest_sha256'; Label = 'HYP024 static non-repaint manifest' },
        [pscustomobject]@{ PathField = 'reviewed_static_nonrepaint_audit_path'; ShaField = 'reviewed_static_nonrepaint_audit_sha256'; Label = 'HYP024 static non-repaint audit' }
    )) {
    ...
    foreach ($exactControl in @(
        [pscustomobject]@{ PathField = 'reviewed_nonrepaint_auditor_path'; ShaField = 'reviewed_nonrepaint_auditor_sha256'; ExpectedPath = $nonRepaintToolPath; ExpectedSha = $hyp024NonRepaintAuditorSha256; Label = 'non-repaint auditor' },
        [pscustomobject]@{ PathField = 'reviewed_static_nonrepaint_manifest_path'; ShaField = 'reviewed_static_nonrepaint_manifest_sha256'; ExpectedPath = $hyp024StaticNonRepaintManifestPath; ExpectedSha = $hyp024StaticNonRepaintManifestSha256; Label = 'static non-repaint manifest' },
        [pscustomobject]@{ PathField = 'reviewed_static_nonrepaint_audit_path'; ShaField = 'reviewed_static_nonrepaint_audit_sha256'; ExpectedPath = $hyp024StaticNonRepaintAuditPath; ExpectedSha = $hyp024StaticNonRepaintAuditSha256; Label = 'static non-repaint audit' }
    )) {
        ...
        if (-not [string]::Equals($resolvedPath, [System.IO.Path]::GetFullPath($exactControl.ExpectedPath), [System.StringComparison]::OrdinalIgnoreCase) -or
            ...
            $Blockers.Add("Model0 economic authority does not bind the exact HYP024 $($exactControl.Label) path/SHA256.")
        }
    }
    ...
    $packetAttemptStart = '03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/evidence/HYP-STBS-XAUUSD-M15-024/STBS024-PACKET-BUILD-001/attempt_started.json'
    $packetAttemptTerminal = '03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/evidence/HYP-STBS-XAUUSD-M15-024/STBS024-PACKET-BUILD-001/attempt_terminal.json'
    if (
        [string](Get-ObjectProperty $validation 'packet_build_attempt_id') -cne 'STBS024-PACKET-BUILD-001' -or
        ...
        $Blockers.Add("Model0 economic authority does not bind the exact completed HYP024 packet-build attempt metadata.")
    }
    ...
    if (
        $declaredReservedReview -cne $hyp024ReservedPostPacketReviewRelative -or
        $declaredPlaceholderSha -cne $hyp024ReservedPostPacketReviewPlaceholderSha256 -or
        $declaredFinalReview -cne $hyp024ReservedPostPacketReviewRelative -or
        -not (Test-Sha256Text $declaredFinalReviewSha) -or
        $declaredFinalReviewSha -ceq $hyp024ReservedPostPacketReviewPlaceholderSha256 -or
        [string](Get-ObjectProperty $PacketResult.Packet 'reserved_post_packet_review_path') -cne $hyp024ReservedPostPacketReviewRelative -or
        [string](Get-ObjectProperty $PacketResult.Packet 'reserved_post_packet_review_placeholder_sha256') -cne $hyp024ReservedPostPacketReviewPlaceholderSha256 -or
        [string](Get-ObjectProperty $PacketResult.Packet 'reserved_post_packet_review_status_line') -cne $hyp024ReservedPostPacketReviewStatusLine
    ) {
        $Blockers.Add("Model0 economic authority does not bind the exact reserved-to-final HYP024 post-packet review contract.")
    }
    if (
        [string](Get-ObjectProperty $Contract.LatestRow 'parent_candidate') -cne 'HYP-STBS-XAUUSD-M15-023' -or
        [string](Get-ObjectProperty $validation 'parent_hyp023_terminal_row_sha256') -cne $hyp024ParentTerminalRowSha256 -or
        [string](Get-ObjectProperty $validation 'parent_hyp023_terminal_verdict') -cne $hyp024ParentTerminalVerdict -or
        [string](Get-ObjectProperty $PacketResult.Packet 'parent_hypothesis_id') -cne 'HYP-STBS-XAUUSD-M15-023' -or
        [string](Get-ObjectProperty $PacketResult.Packet 'parent_terminal_row_sha256') -cne $hyp024ParentTerminalRowSha256 -or
        [string](Get-ObjectProperty $PacketResult.Packet 'parent_terminal_verdict') -cne $hyp024ParentTerminalVerdict
    ) {
        $Blockers.Add("Model0 economic authority does not bind the exact terminal HYP023 engineering parent.")
    }
    foreach ($governanceInput in @(
        [pscustomobject]@{ ValidationPath = 'parent_hyp023_failure_packet_path'; ValidationSha = 'parent_hyp023_failure_packet_sha256'; PacketPath = 'parent_failure_packet_path'; PacketSha = 'parent_failure_packet_sha256'; ExpectedPath = $hyp024ParentFailurePacketRelative; ExpectedSha = $hyp024ParentFailurePacketSha256; Label = 'HYP023 failure packet' },
        [pscustomobject]@{ ValidationPath = 'parent_hyp023_post_failure_review_path'; ValidationSha = 'parent_hyp023_post_failure_review_sha256'; PacketPath = 'parent_post_failure_review_path'; PacketSha = 'parent_post_failure_review_sha256'; ExpectedPath = $hyp024ParentFailureReviewRelative; ExpectedSha = $hyp024ParentFailureReviewSha256; Label = 'HYP023 failure review' },
        [pscustomobject]@{ ValidationPath = 'journal_budget_tester_projection_path'; ValidationSha = 'journal_budget_tester_projection_sha256'; PacketPath = 'journal_budget_tester_projection_path'; PacketSha = 'journal_budget_tester_projection_sha256'; ExpectedPath = $hyp024TesterProjectionRelative; ExpectedSha = $hyp024TesterProjectionSha256; Label = 'Tester no-spam projection' },
        [pscustomobject]@{ ValidationPath = 'journal_budget_agent_projection_path'; ValidationSha = 'journal_budget_agent_projection_sha256'; PacketPath = 'journal_budget_agent_projection_path'; PacketSha = 'journal_budget_agent_projection_sha256'; ExpectedPath = $hyp024AgentProjectionRelative; ExpectedSha = $hyp024AgentProjectionSha256; Label = 'Agent no-spam projection' },
        [pscustomobject]@{ ValidationPath = 'journal_budget_addendum_path'; ValidationSha = 'journal_budget_addendum_sha256'; PacketPath = 'journal_budget_addendum_path'; PacketSha = 'journal_budget_addendum_sha256'; ExpectedPath = $hyp024JournalBudgetAddendumRelative; ExpectedSha = $hyp024JournalBudgetAddendumSha256; Label = 'journal-budget addendum' },
        [pscustomobject]@{ ValidationPath = 'bounded_diff_proof_path'; ValidationSha = 'bounded_diff_proof_sha256'; PacketPath = 'bounded_diff_proof_path'; PacketSha = 'bounded_diff_proof_sha256'; ExpectedPath = $hyp024BoundedDiffProofRelative; ExpectedSha = $hyp024BoundedDiffProofSha256; Label = 'V10-to-V11 bounded diff proof' },
        [pscustomobject]@{ ValidationPath = 'source_contract_test_path'; ValidationSha = 'source_contract_test_sha256'; PacketPath = 'source_contract_test_path'; PacketSha = 'source_contract_test_sha256'; ExpectedPath = $hyp024CompactTelemetryTestRelative; ExpectedSha = $hyp024CompactTelemetryTestSha256; Label = 'compact telemetry contract test' }
    )) {
        if (
    ...
    if (
        [int64](Get-ObjectProperty $validation 'journal_budget_tester_projection_bytes') -ne $hyp024TesterProjectionBytes -or
        [int64](Get-ObjectProperty $validation 'journal_budget_agent_projection_bytes') -ne $hyp024AgentProjectionBytes -or
        [int64](Get-ObjectProperty $PacketResult.Packet 'journal_budget_tester_projection_bytes') -ne $hyp024TesterProjectionBytes -or
        [int64](Get-ObjectProperty $PacketResult.Packet 'journal_budget_agent_projection_bytes') -ne $hyp024AgentProjectionBytes -or
        [int64](Get-ObjectProperty $PacketResult.Packet 'journal_budget_projected_combined_bytes') -ne ($hyp024TesterProjectionBytes + $hyp024AgentProjectionBytes)
    ) {
...
function Assert-Hyp024PacketBuildChain($Contract, $PacketResult, $LaunchClaimRecord) {
    if ($Contract.HypothesisId -cne 'HYP-STBS-XAUUSD-M15-024') {
        return
    }
    $validation = Get-ObjectProperty $Contract.LatestRow 'validation'
    $metrics = Get-ObjectProperty $Contract.LatestRow 'metrics'
    $expectedStart = '03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/evidence/HYP-STBS-XAUUSD-M15-024/STBS024-PACKET-BUILD-001/attempt_started.json'
    $expectedTerminal = '03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/evidence/HYP-STBS-XAUUSD-M15-024/STBS024-PACKET-BUILD-001/attempt_terminal.json'
    ...
    if (
        ...
        $reservedReviewRelative -cne $hyp024ReservedPostPacketReviewRelative -or
        $placeholderReviewSha -cne $hyp024ReservedPostPacketReviewPlaceholderSha256 -or
        $finalReviewRelative -cne $hyp024ReservedPostPacketReviewRelative -or
        -not (Test-Sha256Text $finalReviewSha) -or
        $finalReviewSha -ceq $placeholderReviewSha
    ) {
        throw 'HYP024 packet-build authority metadata is not exact.'
    }
    ...
    if (
        ...
        throw 'HYP024 packet-build chain file hash mismatch.'
    }
    ...
    if (-not (Test-ExactObjectKeys $start @(
        ...
        throw 'HYP024 packet-build start/terminal schema is not exact.'
    }
    if (
        [string]$start.schema_version -cne 'alphafactory_packet_attempt_started.v1' -or
        [string]$start.hypothesis_id -cne 'HYP-STBS-XAUUSD-M15-024' -or
        [string]$start.attempt_id -cne 'STBS024-PACKET-BUILD-001' -or
        [string]$start.builder_path -cne '03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/build_stbs024_task_packet.py' -or
        [string]$terminal.schema_version -cne 'alphafactory_packet_attempt_terminal.v1' -or
        [string]$terminal.hypothesis_id -cne 'HYP-STBS-XAUUSD-M15-024' -or
        [string]$terminal.attempt_id -cne 'STBS024-PACKET-BUILD-001' -or
        ...
        [string](Get-ObjectProperty $PacketResult.Packet 'packet_build_attempt_id') -cne 'STBS024-PACKET-BUILD-001' -or
        ...
        throw 'HYP024 packet-build start/terminal/packet semantic chain is invalid.'
    }
    $reviewStatusMatches = @(
        @(Get-ObjectProperty $PacketResult.Packet 'git_status') |
            Where-Object { [string]$_ -ceq $hyp024ReservedPostPacketReviewStatusLine }
    )
    ...
    if ($reviewStatusMatches.Count -ne 1 -or -not $reviewExact) {
        throw 'HYP024 final post-packet review is not the exact five-line packet/terminal-bound PASS_SCREENED_AUTHORITY control.'
    }
    ...
    foreach ($rawRegistryLine in @(Get-Content -LiteralPath $Contract.RegistryPath)) {
        if ((Get-TextSha256 ([string]$rawRegistryLine)) -ceq $hyp024ParentTerminalRowSha256) {
            $parentMatches.Add(([string]$rawRegistryLine | ConvertFrom-Json))
        }
    }
    if (
        $parentMatches.Count -ne 1 -or
        [string]$parentMatches[0].hypothesis_id -cne 'HYP-STBS-XAUUSD-M15-023' -or
        [string]$parentMatches[0].state -cne 'killed' -or
        [string]$parentMatches[0].verdict -cne $hyp024ParentTerminalVerdict
    ) {
        throw 'HYP024 current registry does not contain the exact hash-bound terminal HYP023 parent row.'
    }
    foreach ($governanceInput in @(
        [pscustomobject]@{ PathField = 'parent_hyp023_failure_packet_path'; ShaField = 'parent_hyp023_failure_packet_sha256'; ExpectedPath = $hyp024ParentFailurePacketRelative; ExpectedSha = $hyp024ParentFailurePacketSha256; ExpectedBytes = $null },
        [pscustomobject]@{ PathField = 'parent_hyp023_post_failure_review_path'; ShaField = 'parent_hyp023_post_failure_review_sha256'; ExpectedPath = $hyp024ParentFailureReviewRelative; ExpectedSha = $hyp024ParentFailureReviewSha256; ExpectedBytes = $null },
        [pscustomobject]@{ PathField = 'journal_budget_tester_projection_path'; ShaField = 'journal_budget_tester_projection_sha256'; ExpectedPath = $hyp024TesterProjectionRelative; ExpectedSha = $hyp024TesterProjectionSha256; ExpectedBytes = $hyp024TesterProjectionBytes },
        [pscustomobject]@{ PathField = 'journal_budget_agent_projection_path'; ShaField = 'journal_budget_agent_projection_sha256'; ExpectedPath = $hyp024AgentProjectionRelative; ExpectedSha = $hyp024AgentProjectionSha256; ExpectedBytes = $hyp024AgentProjectionBytes },
        [pscustomobject]@{ PathField = 'journal_budget_addendum_path'; ShaField = 'journal_budget_addendum_sha256'; ExpectedPath = $hyp024JournalBudgetAddendumRelative; ExpectedSha = $hyp024JournalBudgetAddendumSha256; ExpectedBytes = $null },
        [pscustomobject]@{ PathField = 'bounded_diff_proof_path'; ShaField = 'bounded_diff_proof_sha256'; ExpectedPath = $hyp024BoundedDiffProofRelative; ExpectedSha = $hyp024BoundedDiffProofSha256; ExpectedBytes = $null },
        [pscustomobject]@{ PathField = 'source_contract_test_path'; ShaField = 'source_contract_test_sha256'; ExpectedPath = $hyp024CompactTelemetryTestRelative; ExpectedSha = $hyp024CompactTelemetryTestSha256; ExpectedBytes = $null }
    )) {
        ...
        if (
            ...
            throw "HYP024 governance/cap evidence drifted: $($governanceInput.ExpectedPath)"
        }
    }
    if ($null -eq $LaunchClaimRecord -or -not (Test-Path -LiteralPath $LaunchClaimRecord.Path -PathType Leaf)) {
        throw 'HYP024 Model0 launch claim is absent before packet-build chain validation.'
    }
    ...
    if (-not ($startAt -le $terminalAt -and $terminalAt -le $authorityAt -and $authorityAt -le $launchAt)) {
        throw 'HYP024 packet-build/start/terminal/authority/launch chronology is invalid.'
    }
}
...
function New-ExecutionReceipt($ReceiptPath, $Contract, $PacketResult, $Binding, $LaunchClaimRecord = $null, [string]$RunnerPath = $PSCommandPath) {
    ...
    if ([string]$PacketResult.Authority -ceq 'MODEL0_TRAIN_FALSIFICATION_ONLY' -and
        $Contract.HypothesisId -ceq 'HYP-STBS-XAUUSD-M15-024') {
        $validation = Get-ObjectProperty $Contract.LatestRow 'validation'
        foreach ($packetControl in @(
            [pscustomobject]@{ Label = 'hyp024_packet_attempt_start'; PathField = 'packet_build_attempt_start_path'; ShaField = 'packet_build_attempt_start_sha256' },
            [pscustomobject]@{ Label = 'hyp024_packet_attempt_terminal'; PathField = 'packet_build_attempt_terminal_path'; ShaField = 'packet_build_attempt_terminal_sha256' },
            [pscustomobject]@{ Label = 'hyp024_gitignore'; PathField = 'gitignore_path'; ShaField = 'gitignore_sha256' },
            [pscustomobject]@{ Label = 'hyp024_independent_post_packet_review'; PathField = 'independent_post_packet_review_path'; ShaField = 'independent_post_packet_review_sha256' }
        )) {
        ...
        foreach ($governanceControl in @(
            [pscustomobject]@{ Label = 'hyp024_parent_failure_packet'; PathField = 'parent_hyp023_failure_packet_path'; ShaField = 'parent_hyp023_failure_packet_sha256' },
            [pscustomobject]@{ Label = 'hyp024_parent_failure_review'; PathField = 'parent_hyp023_post_failure_review_path'; ShaField = 'parent_hyp023_post_failure_review_sha256' },
            [pscustomobject]@{ Label = 'hyp024_tester_no_spam_projection'; PathField = 'journal_budget_tester_projection_path'; ShaField = 'journal_budget_tester_projection_sha256' },
            [pscustomobject]@{ Label = 'hyp024_agent_no_spam_projection'; PathField = 'journal_budget_agent_projection_path'; ShaField = 'journal_budget_agent_projection_sha256' },
            [pscustomobject]@{ Label = 'hyp024_journal_budget_addendum'; PathField = 'journal_budget_addendum_path'; ShaField = 'journal_budget_addendum_sha256' },
            [pscustomobject]@{ Label = 'hyp024_bounded_diff_proof'; PathField = 'bounded_diff_proof_path'; ShaField = 'bounded_diff_proof_sha256' },
            [pscustomobject]@{ Label = 'hyp024_compact_telemetry_test'; PathField = 'source_contract_test_path'; ShaField = 'source_contract_test_sha256' }
        )) {
        ...
        foreach ($boundControl in @(
            [pscustomobject]@{ Label = 'hyp024_nonrepaint_auditor'; PathField = 'reviewed_nonrepaint_auditor_path'; ShaField = 'reviewed_nonrepaint_auditor_sha256' },
            [pscustomobject]@{ Label = 'hyp024_static_nonrepaint_manifest'; PathField = 'reviewed_static_nonrepaint_manifest_path'; ShaField = 'reviewed_static_nonrepaint_manifest_sha256' },
            [pscustomobject]@{ Label = 'hyp024_static_nonrepaint_audit'; PathField = 'reviewed_static_nonrepaint_audit_path'; ShaField = 'reviewed_static_nonrepaint_audit_sha256' }
        )) {
...
function New-Hyp024NonRepaintAuditManifest($RunManifestPath, $RunManifestSha256, $AnalysisDir) {
    if ($HypothesisId -cne 'HYP-STBS-XAUUSD-M15-024' -or
        $EaName -cne 'EA_SupertrendBurstScalperTradeV11') {
        throw "The HYP024 runner cannot adapt another hypothesis or EA."
    }
    if ((Get-Sha256IfExists $hyp024StaticNonRepaintManifestPath) -ine $hyp024StaticNonRepaintManifestSha256) {
        throw "HYP024 static non-repaint manifest hash mismatch."
    }
    $static = Get-Content -LiteralPath $hyp024StaticNonRepaintManifestPath -Raw | ConvertFrom-Json
    if ((Get-Sha256IfExists $hyp024StaticNonRepaintManifestPath) -ine $hyp024StaticNonRepaintManifestSha256) {
        throw "HYP024 static non-repaint manifest changed while being read."
    }
    if ([string]$static.hypothesis_id -cne $HypothesisId -or
        [string]$static.source_sha256 -cne $hyp024SourceSha256 -or
        $static.nondecision_provenance_copytime_authorized -ne $true) {
        throw "HYP024 static non-repaint provenance authority is invalid."
    }
    if ((Get-Sha256IfExists $RunManifestPath) -ine $RunManifestSha256) {
        throw "HYP024 original run manifest drifted before the audit adapter read."
    }
    $run = Get-Content -LiteralPath $RunManifestPath -Raw | ConvertFrom-Json
    if ((Get-Sha256IfExists $RunManifestPath) -ine $RunManifestSha256) {
        throw "HYP024 original run manifest changed while being read."
    }
    if ([string]$run.hypothesis_id -cne $HypothesisId -or
        [string]$run.ea_name -cne $EaName -or
        [string]$run.source_sha256 -cne $hyp024SourceSha256) {
        throw "HYP024 run manifest identity does not match the frozen static provenance authority."
    }
    if ($null -ne $run.PSObject.Properties['nondecision_provenance_copytime_authorized'] -or
        ...
        throw "Original HYP024 run manifest already contains unexpected provenance fields."
    }
    ...
    $run | Add-Member -MemberType NoteProperty -Name nondecision_provenance_authority_source -Value ([ordered]@{
        path = $hyp024StaticNonRepaintManifestPath
        sha256 = $hyp024StaticNonRepaintManifestSha256
    ...
    if ((Get-Sha256IfExists $RunManifestPath) -ine $RunManifestSha256) {
        throw "HYP024 original run manifest changed while the derivative was written."
    }
    return $out
}
...
if ($EaName -cne 'EA_SupertrendBurstScalperTradeV11' -or
    $HypothesisId -cne 'HYP-STBS-XAUUSD-M15-024' -or
    ...
    throw "The HYP024 runner accepts only the frozen XAUUSD M15 2005-2023 Model0 control baseline contract."
}
...
try {
    ...
    if ($null -ne $launchClaimRecord) {
        if ($contract.HypothesisId -ceq 'HYP-STBS-XAUUSD-M15-024') {
            ...
            foreach ($governancePathField in @(
                'parent_hyp023_failure_packet_path',
                'parent_hyp023_post_failure_review_path',
                'journal_budget_tester_projection_path',
                'journal_budget_agent_projection_path',
            ...
            Assert-Hyp024PacketBuildChain $contract $packetResult $launchClaimRecord
        }
    ...
    $nonRepaintRunManifestPath = New-Hyp024NonRepaintAuditManifest $runManifestPath $runManifestShaForAudit $analysisDir
    ...
    if ($nonRepaintAuditorShaForAudit -cne $hyp024NonRepaintAuditorSha256) {
        throw "HYP024 non-repaint auditor hash drifted before execution."
    }
    ...
    if ($auditedFiles.Count -ne 1 -or
        ...
        [string]$auditedFiles[0].sha256 -cne $hyp024SourceSha256 -or
        ...
        [int]$allowedGates[0].line -ne $hyp024CopyTimeLine -or
    ...
    if ((Get-Sha256IfExists $nonRepaintToolPath) -cne $nonRepaintAuditorShaForAudit -or
        ...
        throw "HYP024 non-repaint auditor, derivative manifest or audit artifact drifted during validation."
    }
    ...
    $evidence.nonrepaint_audited_source_sha256 = $hyp024SourceSha256
    $evidence.nonrepaint_allowed_gate = [ordered]@{
        path = $expectedSnapshotSourcePath
        line = $hyp024CopyTimeLine
