...
$hyp025NonRepaintAuditorSha256 = "366D70F0C6FAF02F85B4819E7305CD1BD271BA6A78B4789CF0DCDF2FB651E360"
$hyp025StaticNonRepaintManifestPath = Join-Path $repoRoot "03. EA Developer\EA_SupertrendBurstScalperTradeV12\HYP-STBS-XAUUSD-M15-025_NONREPAINT_MANIFEST.json"
$hyp025StaticNonRepaintManifestSha256 = "B8D52779E516C8BD5B3BD776BECF80B98EC26E568FF0B443A7C74362DAB81A2A"
$hyp025StaticNonRepaintAuditPath = Join-Path $repoRoot "03. EA Developer\EA_SupertrendBurstScalperTradeV12\research\HYP-STBS-XAUUSD-M15-025_NONREPAINT_AUDIT.json"
$hyp025StaticNonRepaintAuditSha256 = "3ECC757DB44BD40BF77AAD25BA9131704DCA452F7C7137557A85FDEA84A8AF2E"
$hyp025SourceSha256 = "D96F55A26F277CFC3FDC4E23A11A84C74598C111639E629CEC1877AC3F7704C5"
$hyp025ReservedPostPacketReviewRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/HYP-STBS-XAUUSD-M15-025_POST_PACKET_REVIEW.md"
$hyp025ReservedPostPacketReviewPlaceholderSha256 = "AF754D47474FC0BD8338C0D95FC664F4C6AFD2B886BFE33FE1BF0872944DEAE7"
$hyp025ReservedPostPacketReviewStatusLine = '?? "03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/HYP-STBS-XAUUSD-M15-025_POST_PACKET_REVIEW.md"'
$hyp025ParentTerminalRowSha256 = "0DF555A30DE1674919A736177BA9CFAC0B587FA7B15AD12A1CB174CF5B3EF47E"
$hyp025ParentTerminalVerdict = "KILL_PRE_MT5_AUTHORITY_MISSING_PRE_EXECUTION_HARNESS_ADDENDUM_NO_RUN_NO_ECONOMIC_VERDICT"
$hyp025ParentFailurePacketRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/HYP-STBS-XAUUSD-M15-024_PRE_MT5_AUTHORITY_FAILURE.md"
$hyp025ParentFailurePacketSha256 = "D58707EF9ADCCEE78FEFBCAFBB35B06342D3DDB5A641421097EA77EBD674ADEA"
$hyp025ParentFailureReviewRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV11/research/HYP-STBS-XAUUSD-M15-024_INDEPENDENT_POST_FAILURE_REVIEW.md"
$hyp025ParentFailureReviewSha256 = "B953B81C316690F8F0B4E7EB226F10E16FE49B68B6DD31102D2E90F9E87548E3"
$hyp025TesterProjectionRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV10/research/evidence/HYP-STBS-XAUUSD-M15-023/STBS023-FAILURE-CLOSE-001/tester_hyp023_no_spam_projection.utf16le.log"
$hyp025TesterProjectionSha256 = "DDE409FE80DE6687DD0A520D0B4EAD2F20817142C212CD40E9E7FAFB2CC4EC7B"
$hyp025TesterProjectionBytes = 871692L
$hyp025AgentProjectionRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV10/research/evidence/HYP-STBS-XAUUSD-M15-023/STBS023-FAILURE-CLOSE-001/agent_hyp023_no_spam_projection.utf16le.log"
$hyp025AgentProjectionSha256 = "2F08B3860EB6247BF168331914754650548155FFC93513FD51FA539369BCE7AF"
$hyp025AgentProjectionBytes = 858852L
$hyp025JournalBudgetAddendumRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/HYP-STBS-XAUUSD-M15-025_JOURNAL_BUDGET_ADDENDUM.md"
$hyp025JournalBudgetAddendumSha256 = "F256F9FA6A3358ABD2658BDF59240B38B28DDEB97D363D3C1C4F7283478A1A85"
$hyp025PreExecutionHarnessAddendumRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/HYP-STBS-XAUUSD-M15-025_PRE_EXECUTION_HARNESS_ADDENDUM.md"
$hyp025PreExecutionHarnessAddendumSha256 = "C098ADC331255509C6FF7905F65F335FC1252857D80AA094E98410B56BB62951"
$hyp025BoundedDiffProofRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/HYP-STBS-XAUUSD-M15-025_V11_V12_IDENTITY_DIFF_PROOF.md"
$hyp025BoundedDiffProofSha256 = "507F9E3F75EECE7F107499ECF083D929E70535D424C7FA836B301C6D8F61F11C"
$hyp025CompactTelemetryTestRelative = "03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/tests/test_stbs025_v12_identity_contract.py"
$hyp025CompactTelemetryTestSha256 = "07E235A86CEBFD7809FAA721565A2943DB7607F62BAB2B8D7099D3C6CF94384F"
$hyp025CopyTimeLine = 678
...
function Write-EarlyModel0FailureTerminal([string]$ErrorMessage) {
    ...
    $terminal = [ordered]@{
        ...
        attempt_id = 'STBS025-MODEL0-TRAIN-001'
        status = 'FAILED'
...
function New-EarlyModel0EconomicLaunchClaim {
    ...
    if ($EaName -cne 'EA_SupertrendBurstScalperTradeV12' -or
        $HypothesisId -cne 'HYP-STBS-XAUUSD-M15-025' -or
        ...
        throw 'HYP025 execution scalars are invalid before claim.'
    }
    ...
    for ($index = 0; $index -lt $rows.Count; $index++) {
        ...
        if ([string]$row.hypothesis_id -ceq 'HYP-STBS-XAUUSD-M15-025') {
            $latest = $row
    ...
    if ($null -eq $latest -or [string]$latest.state -cne 'screened') {
        throw 'HYP025 early claim requires the latest screened authority row.'
    }
    $validation = $latest.validation
    $metrics = $latest.metrics
    $expectedPacket = '03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/preflight/HYP-STBS-XAUUSD-M15-025/V1/task_packet.control.json'
    if ([string]$validation.authority -cne 'MODEL0_TRAIN_FALSIFICATION_ONLY' -or
        ...
        [string]$validation.mt5_attempt_id -cne 'STBS025-MODEL0-TRAIN-001' -or
        ...
        throw 'HYP025 screened authority metadata is invalid before claim.'
    }
    $root = Join-Path $runtimeRoot 'model0_economic_attempts\HYP-STBS-XAUUSD-M15-025\STBS025-MODEL0-TRAIN-001'
    ...
    $attemptRecord = [pscustomobject]@{
        ...
        AttemptId = 'STBS025-MODEL0-TRAIN-001'
        Path = $startPath
...
function Add-Model0EconomicLaunchAuthorityBlockers(
    ...
    if ([string](Get-ObjectProperty $PacketResult.Packet 'inner_implementation_hypothesis_id') -cne 'HYP-STBS-XAUUSD-M15-025') {
        $Blockers.Add('HYP025 task packet must bind the exact inner MQL5/RunMeta/lifecycle identity HYP025.')
    }
    ...
    foreach ($boundControl in @(
        ...
        [pscustomobject]@{ PathField = 'reviewed_nonrepaint_auditor_path'; ShaField = 'reviewed_nonrepaint_auditor_sha256'; Label = 'HYP025 non-repaint auditor' },
        [pscustomobject]@{ PathField = 'reviewed_static_nonrepaint_manifest_path'; ShaField = 'reviewed_static_nonrepaint_manifest_sha256'; Label = 'HYP025 static non-repaint manifest' },
        [pscustomobject]@{ PathField = 'reviewed_static_nonrepaint_audit_path'; ShaField = 'reviewed_static_nonrepaint_audit_sha256'; Label = 'HYP025 static non-repaint audit' }
    )) {
    ...
    foreach ($exactControl in @(
        [pscustomobject]@{ PathField = 'reviewed_nonrepaint_auditor_path'; ShaField = 'reviewed_nonrepaint_auditor_sha256'; ExpectedPath = $nonRepaintToolPath; ExpectedSha = $hyp025NonRepaintAuditorSha256; Label = 'non-repaint auditor' },
        [pscustomobject]@{ PathField = 'reviewed_static_nonrepaint_manifest_path'; ShaField = 'reviewed_static_nonrepaint_manifest_sha256'; ExpectedPath = $hyp025StaticNonRepaintManifestPath; ExpectedSha = $hyp025StaticNonRepaintManifestSha256; Label = 'static non-repaint manifest' },
        [pscustomobject]@{ PathField = 'reviewed_static_nonrepaint_audit_path'; ShaField = 'reviewed_static_nonrepaint_audit_sha256'; ExpectedPath = $hyp025StaticNonRepaintAuditPath; ExpectedSha = $hyp025StaticNonRepaintAuditSha256; Label = 'static non-repaint audit' }
    )) {
        ...
        if (-not [string]::Equals($resolvedPath, [System.IO.Path]::GetFullPath($exactControl.ExpectedPath), [System.StringComparison]::OrdinalIgnoreCase) -or
            ...
            $Blockers.Add("Model0 economic authority does not bind the exact HYP025 $($exactControl.Label) path/SHA256.")
        }
    }
    ...
    $packetAttemptStart = '03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/evidence/HYP-STBS-XAUUSD-M15-025/STBS025-PACKET-BUILD-001/attempt_started.json'
    $packetAttemptTerminal = '03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/evidence/HYP-STBS-XAUUSD-M15-025/STBS025-PACKET-BUILD-001/attempt_terminal.json'
    if (
        [string](Get-ObjectProperty $validation 'packet_build_attempt_id') -cne 'STBS025-PACKET-BUILD-001' -or
        ...
        $Blockers.Add("Model0 economic authority does not bind the exact completed HYP025 packet-build attempt metadata.")
    }
    ...
    if (
        $declaredReservedReview -cne $hyp025ReservedPostPacketReviewRelative -or
        $declaredPlaceholderSha -cne $hyp025ReservedPostPacketReviewPlaceholderSha256 -or
        $declaredFinalReview -cne $hyp025ReservedPostPacketReviewRelative -or
        -not (Test-Sha256Text $declaredFinalReviewSha) -or
        $declaredFinalReviewSha -ceq $hyp025ReservedPostPacketReviewPlaceholderSha256 -or
        [string](Get-ObjectProperty $PacketResult.Packet 'reserved_post_packet_review_path') -cne $hyp025ReservedPostPacketReviewRelative -or
        [string](Get-ObjectProperty $PacketResult.Packet 'reserved_post_packet_review_placeholder_sha256') -cne $hyp025ReservedPostPacketReviewPlaceholderSha256 -or
        [string](Get-ObjectProperty $PacketResult.Packet 'reserved_post_packet_review_status_line') -cne $hyp025ReservedPostPacketReviewStatusLine
    ) {
        $Blockers.Add("Model0 economic authority does not bind the exact reserved-to-final HYP025 post-packet review contract.")
    }
    if (
        [string](Get-ObjectProperty $Contract.LatestRow 'parent_candidate') -cne 'HYP-STBS-XAUUSD-M15-024' -or
        [string](Get-ObjectProperty $validation 'parent_hyp024_terminal_row_sha256') -cne $hyp025ParentTerminalRowSha256 -or
        [string](Get-ObjectProperty $validation 'parent_hyp024_terminal_verdict') -cne $hyp025ParentTerminalVerdict -or
        [string](Get-ObjectProperty $PacketResult.Packet 'parent_hypothesis_id') -cne 'HYP-STBS-XAUUSD-M15-024' -or
        [string](Get-ObjectProperty $PacketResult.Packet 'parent_terminal_row_sha256') -cne $hyp025ParentTerminalRowSha256 -or
        [string](Get-ObjectProperty $PacketResult.Packet 'parent_terminal_verdict') -cne $hyp025ParentTerminalVerdict
    ) {
        $Blockers.Add("Model0 economic authority does not bind the exact terminal HYP024 pre-MT5 parent.")
    }
    if (
        [string](Get-ObjectProperty $validation 'exact_outer_hypothesis_id') -cne 'HYP-STBS-XAUUSD-M15-025' -or
        [string](Get-ObjectProperty $validation 'exact_inner_mql_identity') -cne 'HYP-STBS-XAUUSD-M15-025'
    ) {
        $Blockers.Add("Model0 economic authority does not bind the exact HYP025 outer/inner identity contract.")
    }
    foreach ($governanceInput in @(
        [pscustomobject]@{ ValidationPath = 'parent_hyp024_failure_path'; ValidationSha = 'parent_hyp024_failure_sha256'; PacketPath = 'parent_failure_packet_path'; PacketSha = 'parent_failure_packet_sha256'; ExpectedPath = $hyp025ParentFailurePacketRelative; ExpectedSha = $hyp025ParentFailurePacketSha256; Label = 'HYP024 failure note' },
        [pscustomobject]@{ ValidationPath = 'parent_hyp024_post_failure_review_path'; ValidationSha = 'parent_hyp024_post_failure_review_sha256'; PacketPath = 'parent_post_failure_review_path'; PacketSha = 'parent_post_failure_review_sha256'; ExpectedPath = $hyp025ParentFailureReviewRelative; ExpectedSha = $hyp025ParentFailureReviewSha256; Label = 'HYP024 failure review' },
        [pscustomobject]@{ ValidationPath = 'journal_budget_tester_projection_path'; ValidationSha = 'journal_budget_tester_projection_sha256'; PacketPath = 'journal_budget_tester_projection_path'; PacketSha = 'journal_budget_tester_projection_sha256'; ExpectedPath = $hyp025TesterProjectionRelative; ExpectedSha = $hyp025TesterProjectionSha256; Label = 'Tester no-spam projection' },
        [pscustomobject]@{ ValidationPath = 'journal_budget_agent_projection_path'; ValidationSha = 'journal_budget_agent_projection_sha256'; PacketPath = 'journal_budget_agent_projection_path'; PacketSha = 'journal_budget_agent_projection_sha256'; ExpectedPath = $hyp025AgentProjectionRelative; ExpectedSha = $hyp025AgentProjectionSha256; Label = 'Agent no-spam projection' },
        [pscustomobject]@{ ValidationPath = 'journal_budget_addendum_path'; ValidationSha = 'journal_budget_addendum_sha256'; PacketPath = 'journal_budget_addendum_path'; PacketSha = 'journal_budget_addendum_sha256'; ExpectedPath = $hyp025JournalBudgetAddendumRelative; ExpectedSha = $hyp025JournalBudgetAddendumSha256; Label = 'journal-budget addendum' },
        [pscustomobject]@{ ValidationPath = 'pre_execution_harness_addendum_path'; ValidationSha = 'pre_execution_harness_addendum_sha256'; PacketPath = 'pre_execution_harness_addendum_path'; PacketSha = 'pre_execution_harness_addendum_sha256'; ExpectedPath = $hyp025PreExecutionHarnessAddendumRelative; ExpectedSha = $hyp025PreExecutionHarnessAddendumSha256; Label = 'pre-execution harness addendum' },
        [pscustomobject]@{ ValidationPath = 'bounded_diff_proof_path'; ValidationSha = 'bounded_diff_proof_sha256'; PacketPath = 'bounded_diff_proof_path'; PacketSha = 'bounded_diff_proof_sha256'; ExpectedPath = $hyp025BoundedDiffProofRelative; ExpectedSha = $hyp025BoundedDiffProofSha256; Label = 'V11-to-V12 identity-only diff proof' },
        [pscustomobject]@{ ValidationPath = 'source_contract_test_path'; ValidationSha = 'source_contract_test_sha256'; PacketPath = 'source_contract_test_path'; PacketSha = 'source_contract_test_sha256'; ExpectedPath = $hyp025CompactTelemetryTestRelative; ExpectedSha = $hyp025CompactTelemetryTestSha256; Label = 'compact telemetry contract test' }
    )) {
        if (
    ...
    if (
        [int64](Get-ObjectProperty $validation 'journal_budget_tester_projection_bytes') -ne $hyp025TesterProjectionBytes -or
        [int64](Get-ObjectProperty $validation 'journal_budget_agent_projection_bytes') -ne $hyp025AgentProjectionBytes -or
        [int64](Get-ObjectProperty $PacketResult.Packet 'journal_budget_tester_projection_bytes') -ne $hyp025TesterProjectionBytes -or
        [int64](Get-ObjectProperty $PacketResult.Packet 'journal_budget_agent_projection_bytes') -ne $hyp025AgentProjectionBytes -or
        [int64](Get-ObjectProperty $PacketResult.Packet 'journal_budget_projected_combined_bytes') -ne ($hyp025TesterProjectionBytes + $hyp025AgentProjectionBytes)
    ) {
...
function New-Model0EconomicLaunchClaim($Contract, $Binding, $PacketResult) {
    ...
    if ($Contract.HypothesisId -ceq 'HYP-STBS-XAUUSD-M15-025') {
        $early = $script:earlyModel0EconomicAttemptRecord
        if ($null -eq $early) {
            throw 'HYP025 execution reached post-claim validation without the durable early Model0 claim.'
        }
        if ([string]$Contract.RegistrySha256 -cne [string]$early.RegistrySha256 -or
            [string]$Contract.RegistryRowSha256 -cne [string]$early.RegistryRowSha256 -or
            (Get-RepoRelativePath $PacketResult.PacketPath) -cne [string]$early.TaskPacketPath -or
            [string]$PacketResult.PacketSha256 -cne [string]$early.TaskPacketSha256 -or
            (Get-Sha256IfExists ([string]$early.Path)) -cne [string]$early.Sha256) {
            throw 'HYP025 post-claim registry/task-packet reconciliation failed.'
        }
        return $early
    }
    $paths = Get-Model0EconomicAttemptPaths $Contract
...
function Assert-Hyp025PacketBuildChain($Contract, $PacketResult, $LaunchClaimRecord) {
    if ($Contract.HypothesisId -cne 'HYP-STBS-XAUUSD-M15-025') {
        return
    }
    $validation = Get-ObjectProperty $Contract.LatestRow 'validation'
    $metrics = Get-ObjectProperty $Contract.LatestRow 'metrics'
    $expectedStart = '03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/evidence/HYP-STBS-XAUUSD-M15-025/STBS025-PACKET-BUILD-001/attempt_started.json'
    $expectedTerminal = '03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/evidence/HYP-STBS-XAUUSD-M15-025/STBS025-PACKET-BUILD-001/attempt_terminal.json'
    ...
    if (
        ...
        $reservedReviewRelative -cne $hyp025ReservedPostPacketReviewRelative -or
        $placeholderReviewSha -cne $hyp025ReservedPostPacketReviewPlaceholderSha256 -or
        $finalReviewRelative -cne $hyp025ReservedPostPacketReviewRelative -or
        -not (Test-Sha256Text $finalReviewSha) -or
        $finalReviewSha -ceq $placeholderReviewSha
    ) {
        throw 'HYP025 packet-build authority metadata is not exact.'
    }
    ...
    if (
        ...
        throw 'HYP025 packet-build chain file hash mismatch.'
    }
    ...
    if (-not (Test-ExactObjectKeys $start @(
        ...
        throw 'HYP025 packet-build start/terminal schema is not exact.'
    }
    if (
        [string]$start.schema_version -cne 'alphafactory_packet_attempt_started.v1' -or
        [string]$start.hypothesis_id -cne 'HYP-STBS-XAUUSD-M15-025' -or
        [string]$start.attempt_id -cne 'STBS025-PACKET-BUILD-001' -or
        [string]$start.builder_path -cne '03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/build_stbs025_task_packet.py' -or
        [string]$terminal.schema_version -cne 'alphafactory_packet_attempt_terminal.v1' -or
        [string]$terminal.hypothesis_id -cne 'HYP-STBS-XAUUSD-M15-025' -or
        [string]$terminal.attempt_id -cne 'STBS025-PACKET-BUILD-001' -or
        ...
        [string](Get-ObjectProperty $PacketResult.Packet 'packet_build_attempt_id') -cne 'STBS025-PACKET-BUILD-001' -or
        ...
        throw 'HYP025 packet-build start/terminal/packet semantic chain is invalid.'
    }
    $reviewStatusMatches = @(
        @(Get-ObjectProperty $PacketResult.Packet 'git_status') |
            Where-Object { [string]$_ -ceq $hyp025ReservedPostPacketReviewStatusLine }
    )
    ...
    if ($reviewStatusMatches.Count -ne 1 -or -not $reviewExact) {
        throw 'HYP025 final post-packet review is not the exact five-line packet/terminal-bound PASS_SCREENED_AUTHORITY control.'
    }
    ...
    foreach ($rawRegistryLine in @(Get-Content -LiteralPath $Contract.RegistryPath)) {
        if ((Get-TextSha256 ([string]$rawRegistryLine)) -ceq $hyp025ParentTerminalRowSha256) {
            $parentMatches.Add(([string]$rawRegistryLine | ConvertFrom-Json))
        }
    }
    if (
        $parentMatches.Count -ne 1 -or
        [string]$parentMatches[0].hypothesis_id -cne 'HYP-STBS-XAUUSD-M15-024' -or
        [string]$parentMatches[0].state -cne 'killed' -or
        [string]$parentMatches[0].verdict -cne $hyp025ParentTerminalVerdict
    ) {
        throw 'HYP025 current registry does not contain the exact hash-bound terminal HYP024 parent row.'
    }
    foreach ($governanceInput in @(
        [pscustomobject]@{ PathField = 'parent_hyp024_failure_path'; ShaField = 'parent_hyp024_failure_sha256'; ExpectedPath = $hyp025ParentFailurePacketRelative; ExpectedSha = $hyp025ParentFailurePacketSha256; ExpectedBytes = $null },
        [pscustomobject]@{ PathField = 'parent_hyp024_post_failure_review_path'; ShaField = 'parent_hyp024_post_failure_review_sha256'; ExpectedPath = $hyp025ParentFailureReviewRelative; ExpectedSha = $hyp025ParentFailureReviewSha256; ExpectedBytes = $null },
        [pscustomobject]@{ PathField = 'journal_budget_tester_projection_path'; ShaField = 'journal_budget_tester_projection_sha256'; ExpectedPath = $hyp025TesterProjectionRelative; ExpectedSha = $hyp025TesterProjectionSha256; ExpectedBytes = $hyp025TesterProjectionBytes },
        [pscustomobject]@{ PathField = 'journal_budget_agent_projection_path'; ShaField = 'journal_budget_agent_projection_sha256'; ExpectedPath = $hyp025AgentProjectionRelative; ExpectedSha = $hyp025AgentProjectionSha256; ExpectedBytes = $hyp025AgentProjectionBytes },
        [pscustomobject]@{ PathField = 'journal_budget_addendum_path'; ShaField = 'journal_budget_addendum_sha256'; ExpectedPath = $hyp025JournalBudgetAddendumRelative; ExpectedSha = $hyp025JournalBudgetAddendumSha256; ExpectedBytes = $null },
        [pscustomobject]@{ PathField = 'pre_execution_harness_addendum_path'; ShaField = 'pre_execution_harness_addendum_sha256'; ExpectedPath = $hyp025PreExecutionHarnessAddendumRelative; ExpectedSha = $hyp025PreExecutionHarnessAddendumSha256; ExpectedBytes = $null },
        [pscustomobject]@{ PathField = 'bounded_diff_proof_path'; ShaField = 'bounded_diff_proof_sha256'; ExpectedPath = $hyp025BoundedDiffProofRelative; ExpectedSha = $hyp025BoundedDiffProofSha256; ExpectedBytes = $null },
        [pscustomobject]@{ PathField = 'source_contract_test_path'; ShaField = 'source_contract_test_sha256'; ExpectedPath = $hyp025CompactTelemetryTestRelative; ExpectedSha = $hyp025CompactTelemetryTestSha256; ExpectedBytes = $null }
    )) {
        ...
        if (
            ...
            throw "HYP025 governance/cap evidence drifted: $($governanceInput.ExpectedPath)"
        }
    }
    if ($null -eq $LaunchClaimRecord -or -not (Test-Path -LiteralPath $LaunchClaimRecord.Path -PathType Leaf)) {
        throw 'HYP025 Model0 launch claim is absent before packet-build chain validation.'
    }
    ...
    if (-not ($startAt -le $terminalAt -and $terminalAt -le $authorityAt -and $authorityAt -le $launchAt)) {
        throw 'HYP025 packet-build/start/terminal/authority/launch chronology is invalid.'
    }
}
...
function New-ExecutionReceipt($ReceiptPath, $Contract, $PacketResult, $Binding, $LaunchClaimRecord = $null, [string]$RunnerPath = $PSCommandPath) {
    ...
    if ([string]$PacketResult.Authority -ceq 'MODEL0_TRAIN_FALSIFICATION_ONLY' -and
        $Contract.HypothesisId -ceq 'HYP-STBS-XAUUSD-M15-025') {
        $validation = Get-ObjectProperty $Contract.LatestRow 'validation'
        foreach ($packetControl in @(
            [pscustomobject]@{ Label = 'hyp025_packet_attempt_start'; PathField = 'packet_build_attempt_start_path'; ShaField = 'packet_build_attempt_start_sha256' },
            [pscustomobject]@{ Label = 'hyp025_packet_attempt_terminal'; PathField = 'packet_build_attempt_terminal_path'; ShaField = 'packet_build_attempt_terminal_sha256' },
            [pscustomobject]@{ Label = 'hyp025_gitignore'; PathField = 'gitignore_path'; ShaField = 'gitignore_sha256' },
            [pscustomobject]@{ Label = 'hyp025_independent_post_packet_review'; PathField = 'independent_post_packet_review_path'; ShaField = 'independent_post_packet_review_sha256' }
        )) {
        ...
        foreach ($governanceControl in @(
            [pscustomobject]@{ Label = 'hyp025_parent_failure_packet'; PathField = 'parent_hyp024_failure_path'; ShaField = 'parent_hyp024_failure_sha256' },
            [pscustomobject]@{ Label = 'hyp025_parent_failure_review'; PathField = 'parent_hyp024_post_failure_review_path'; ShaField = 'parent_hyp024_post_failure_review_sha256' },
            [pscustomobject]@{ Label = 'hyp025_tester_no_spam_projection'; PathField = 'journal_budget_tester_projection_path'; ShaField = 'journal_budget_tester_projection_sha256' },
            [pscustomobject]@{ Label = 'hyp025_agent_no_spam_projection'; PathField = 'journal_budget_agent_projection_path'; ShaField = 'journal_budget_agent_projection_sha256' },
            [pscustomobject]@{ Label = 'hyp025_journal_budget_addendum'; PathField = 'journal_budget_addendum_path'; ShaField = 'journal_budget_addendum_sha256' },
            [pscustomobject]@{ Label = 'hyp025_pre_execution_harness_addendum'; PathField = 'pre_execution_harness_addendum_path'; ShaField = 'pre_execution_harness_addendum_sha256' },
            [pscustomobject]@{ Label = 'hyp025_bounded_diff_proof'; PathField = 'bounded_diff_proof_path'; ShaField = 'bounded_diff_proof_sha256' },
            [pscustomobject]@{ Label = 'hyp025_compact_telemetry_test'; PathField = 'source_contract_test_path'; ShaField = 'source_contract_test_sha256' }
        )) {
        ...
        foreach ($boundControl in @(
            [pscustomobject]@{ Label = 'hyp025_nonrepaint_auditor'; PathField = 'reviewed_nonrepaint_auditor_path'; ShaField = 'reviewed_nonrepaint_auditor_sha256' },
            [pscustomobject]@{ Label = 'hyp025_static_nonrepaint_manifest'; PathField = 'reviewed_static_nonrepaint_manifest_path'; ShaField = 'reviewed_static_nonrepaint_manifest_sha256' },
            [pscustomobject]@{ Label = 'hyp025_static_nonrepaint_audit'; PathField = 'reviewed_static_nonrepaint_audit_path'; ShaField = 'reviewed_static_nonrepaint_audit_sha256' }
        )) {
...
function New-Hyp025NonRepaintAuditManifest($RunManifestPath, $RunManifestSha256, $AnalysisDir) {
    if ($HypothesisId -cne 'HYP-STBS-XAUUSD-M15-025' -or
        $EaName -cne 'EA_SupertrendBurstScalperTradeV12') {
        throw "The HYP025 runner cannot adapt another hypothesis or EA."
    }
    if ((Get-Sha256IfExists $hyp025StaticNonRepaintManifestPath) -ine $hyp025StaticNonRepaintManifestSha256) {
        throw "HYP025 static non-repaint manifest hash mismatch."
    }
    $static = Get-Content -LiteralPath $hyp025StaticNonRepaintManifestPath -Raw | ConvertFrom-Json
    if ((Get-Sha256IfExists $hyp025StaticNonRepaintManifestPath) -ine $hyp025StaticNonRepaintManifestSha256) {
        throw "HYP025 static non-repaint manifest changed while being read."
    }
    if ([string]$static.hypothesis_id -cne $HypothesisId -or
        [string]$static.source_sha256 -cne $hyp025SourceSha256 -or
        $static.nondecision_provenance_copytime_authorized -ne $true) {
        throw "HYP025 static non-repaint provenance authority is invalid."
    }
    if ((Get-Sha256IfExists $RunManifestPath) -ine $RunManifestSha256) {
        throw "HYP025 original run manifest drifted before the audit adapter read."
    }
    $run = Get-Content -LiteralPath $RunManifestPath -Raw | ConvertFrom-Json
    if ((Get-Sha256IfExists $RunManifestPath) -ine $RunManifestSha256) {
        throw "HYP025 original run manifest changed while being read."
    }
    if ([string]$run.hypothesis_id -cne $HypothesisId -or
        [string]$run.ea_name -cne $EaName -or
        [string]$run.source_sha256 -cne $hyp025SourceSha256) {
        throw "HYP025 run manifest identity does not match the frozen static provenance authority."
    }
    if ($null -ne $run.PSObject.Properties['nondecision_provenance_copytime_authorized'] -or
        ...
        throw "Original HYP025 run manifest already contains unexpected provenance fields."
    }
    ...
    $run | Add-Member -MemberType NoteProperty -Name nondecision_provenance_authority_source -Value ([ordered]@{
        path = $hyp025StaticNonRepaintManifestPath
        sha256 = $hyp025StaticNonRepaintManifestSha256
    ...
    if ((Get-Sha256IfExists $RunManifestPath) -ine $RunManifestSha256) {
        throw "HYP025 original run manifest changed while the derivative was written."
    }
    return $out
}
...
if ($EaName -cne 'EA_SupertrendBurstScalperTradeV12' -or
    ...
    $TelemetryTier -cne 'trade-only' -or $Deposit -ne 100000 -or $Leverage -ne 100 -or
    -not [string]::IsNullOrWhiteSpace($Spread)) {
    throw "The HYP025 runner accepts only the frozen XAUUSD M15 2005-2023 Model0 control baseline contract."
}
...
try {
    ...
    if ($null -ne $launchClaimRecord) {
        if ($contract.HypothesisId -ceq 'HYP-STBS-XAUUSD-M15-025') {
            ...
            foreach ($governancePathField in @(
                'parent_hyp024_failure_path',
                'parent_hyp024_post_failure_review_path',
                'journal_budget_tester_projection_path',
                'journal_budget_agent_projection_path',
            ...
            Assert-Hyp025PacketBuildChain $contract $packetResult $launchClaimRecord
        }
    ...
    $nonRepaintRunManifestPath = New-Hyp025NonRepaintAuditManifest $runManifestPath $runManifestShaForAudit $analysisDir
    ...
    if ($nonRepaintAuditorShaForAudit -cne $hyp025NonRepaintAuditorSha256) {
        throw "HYP025 non-repaint auditor hash drifted before execution."
    }
    ...
    if ($auditedFiles.Count -ne 1 -or
        ...
        [string]$auditedFiles[0].sha256 -cne $hyp025SourceSha256 -or
        ...
        [int]$allowedGates[0].line -ne $hyp025CopyTimeLine -or
    ...
    if ((Get-Sha256IfExists $nonRepaintToolPath) -cne $nonRepaintAuditorShaForAudit -or
        ...
        throw "HYP025 non-repaint auditor, derivative manifest or audit artifact drifted during validation."
    }
    ...
    $evidence.nonrepaint_audited_source_sha256 = $hyp025SourceSha256
    $evidence.nonrepaint_allowed_gate = [ordered]@{
        path = $expectedSnapshotSourcePath
        line = $hyp025CopyTimeLine
