#!/usr/bin/env python3
"""Build NOGIT contract receipts for discovery wave2 (VWAP/BOS/ATF)."""
import hashlib
import json
...
def build(cfg: dict) -> tuple[str, str]:
    ...
    task_packet = {
        ...
        "run_role": "control",
        "overrides": overrides,
        "note": cfg.get("note", "Discovery wave2; cost unverified."),
    }
...
CFGS = [
    {
        ...
        "ea_name": "EA_M15SessionVWAPReclaim",
        "ea_rel": "03. EA Developer/EA_M15SessionVWAPReclaim/EA_M15SessionVWAPReclaim.mq5",
        "prereg_rel": "03. EA Developer/EA_SonicR/research/preregs/20260714_H_SESSION_VWAP_RECLAIM_M15_001_PREREG.md",
        "stub_rel": "03. EA Developer/EA_SonicR/research/preflight/session_vwap_reclaim_m15/contracts/receipt_stubs_HYP_SVR_001",
        "receipt_name": "20260714_HYP_SESSION_VWAP_RECLAIM_M15_001_CONTRACT_RECEIPT.json",
        "symbol": "USDJPY",
        "period": "M15",
        "deposit": 100000,
        "overrides": "",
        "geometry": {"digits": 3, "point": 0.001, "pip_size": 0.01},
        "note": "Discovery wave2; session VWAP stretch-reclaim; not SB densify.",
    },
    {
        "hypothesis_id": "HYP-H1-BOS-M15-PB-001",
        "ea_name": "EA_H1BOS_M15Pullback",
        "ea_rel": "03. EA Developer/EA_H1BOS_M15Pullback/EA_H1BOS_M15Pullback.mq5",
        "prereg_rel": "03. EA Developer/EA_SonicR/research/preregs/20260714_H_H1_BOS_M15_PB_001_PREREG.md",
        "stub_rel": "03. EA Developer/EA_SonicR/research/preflight/h1_bos_m15_pb/contracts/receipt_stubs_HYP_HBOS_001",
        "receipt_name": "20260714_HYP_H1_BOS_M15_PB_001_CONTRACT_RECEIPT.json",
        "symbol": "USDJPY",
        "period": "M15",
        "deposit": 100000,
        "overrides": "",
        "geometry": {"digits": 3, "point": 0.001, "pip_size": 0.01},
        "note": "Discovery wave2; H1 BOS then M15 EMA pullback; not ITSM.",
    },
    {
        "hypothesis_id": "HYP-ASIAN-TAIL-FADE-USDJPY-001",
        "ea_name": "EA_M15AsianTailFade",
        "ea_rel": "03. EA Developer/EA_M15AsianTailFade/EA_M15AsianTailFade.mq5",
        "prereg_rel": "03. EA Developer/EA_SonicR/research/preregs/20260714_H_ASIAN_TAIL_FADE_USDJPY_001_PREREG.md",
        "stub_rel": "03. EA Developer/EA_SonicR/research/preflight/asian_tail_fade_usdjpy/contracts/receipt_stubs_HYP_ATFJ_001",
        "receipt_name": "20260714_HYP_ASIAN_TAIL_FADE_USDJPY_001_CONTRACT_RECEIPT.json",
        "symbol": "USDJPY",
        "period": "M15",
        "deposit": 100000,
        "overrides": "",
        "geometry": {"digits": 3, "point": 0.001, "pip_size": 0.01},
        "note": "Discovery wave2; AsianTailFade USDJPY ATR port; not Spark/ASR.",
    },
]
