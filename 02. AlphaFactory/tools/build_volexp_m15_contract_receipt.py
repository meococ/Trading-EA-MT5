#!/usr/bin/env python3
"""Build HYP-VOLEXP-M15-001 contract receipt matching alpha.ps1 NOGIT provenance."""
import hashlib
import json
...
prereg = root / "03. EA Developer/EA_SonicR/research/preregs/20260713_H_VOLEXP_M15_001_PREREG.md"
stub_dir = root / "03. EA Developer/EA_SonicR/research/preflight/volexp_m15/contracts/receipt_stubs_HYP_VOLEXP_M15_001"
...
# Must match alpha.ps1 Assert-ContractReceipt: sort include_* by path,
# then "<fullpath_lower>\t<SHA256>" joined by newlines.
...
receipt = {
    ...
    "note": "Model 0 control screen for vol-expansion M15. Binding must match alpha.ps1 invocation. Cost provenance unverified.",
}
receipt_path = contracts / "20260713_HYP_VOLEXP_M15_001_CONTRACT_RECEIPT.json"
receipt_path.write_text(json.dumps(receipt, indent=2) + "\n", encoding="utf-8")
receipt_sha = sha256_file(receipt_path)
print("RECEIPT", receipt_path)
print("RECEIPT_SHA256", receipt_sha)
(contracts / "20260713_HYP_VOLEXP_M15_001_CONTRACT_RECEIPT.sha256.txt").write_text(
    receipt_sha + "\n", encoding="utf-8"
)
