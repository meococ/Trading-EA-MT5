#!/usr/bin/env python3
"""Build HYP-GOLDJPY-LEAD-M15-001 contract receipt matching alpha.ps1 NOGIT provenance."""
import hashlib
import json
...
ea = root / "03. EA Developer/EA_M15GoldJPYLead/EA_M15GoldJPYLead.mq5"
agents = root / "AGENTS.md"
goal = root / "01. GOAL/GOAL.md"
prereg = root / "03. EA Developer/EA_SonicR/research/preregs/20260714_H_GOLDJPY_LEAD_M15_001_PREREG.md"
stub_dir = root / (
    "03. EA Developer/EA_SonicR/research/preflight/goldjpy_lead_m15/"
    "contracts/receipt_stubs_HYP_GOLDJPY_LEAD_M15_001"
)
...
task_packet = {
    ...
    "hypothesis_id": "HYP-GOLDJPY-LEAD-M15-001",
    "ea_name": "EA_M15GoldJPYLead",
    "symbol": "USDJPY",
    "period": "M15",
    "from": "2021.01.01",
    "to": "2025.12.31",
    "model": 0,
    "run_role": "control",
    "note": "Model 0 screen; LOCAL_SELF_RESEARCH_ONLY; GPT_DEEP_RESEARCH_WAIVED.",
}
...
(stub_dir / "include_note.txt").write_text(
    "EA_M15GoldJPYLead is single-file; Trade.mqh is MT5 standard library. "
...
receipt = {
    ...
    "note": "Model 0 control screen for GoldJPY lead M15. GPT_DEEP_RESEARCH_WAIVED / LOCAL_SELF_RESEARCH_ONLY.",
}
receipt_path = contracts / "20260714_HYP_GOLDJPY_LEAD_M15_001_CONTRACT_RECEIPT.json"
receipt_path.write_text(json.dumps(receipt, indent=2) + "\n", encoding="utf-8")
receipt_sha = sha256_file(receipt_path)
print("RECEIPT", receipt_path)
print("RECEIPT_SHA256", receipt_sha)
(contracts / "20260714_HYP_GOLDJPY_LEAD_M15_001_CONTRACT_RECEIPT.sha256.txt").write_text(
    receipt_sha + "\n", encoding="utf-8"
)
