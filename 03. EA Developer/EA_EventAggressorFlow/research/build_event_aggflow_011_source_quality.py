...
#!/usr/bin/env python3
"""Run frozen HYP011 source quality using the reviewed HYP007 foundation."""
...
HYPOTHESIS_ID = "HYP-EVENT-AGGFLOW-EURUSD-TICK-011"
ATTEMPT_ID = "EVENTAGGFLOW011-SOURCE-QUALITY-001"
...
TOOL_REL = BASE_REL + "build_event_aggflow_011_source_quality.py"
TEST_REL = BASE_REL + "tests/test_build_event_aggflow_011_source_quality.py"
...
PLAN_SHA256 = "9326FB7F06E8DBC00D738362A84CC3B735364FE43972F0F4A4CFB404D059A6BA"
...
def load_foundation(workspace: Path) -> Any:
    ...
    spec = importlib.util.spec_from_file_location("event_aggflow_011_foundation", path)
    ...
    module.validate_parent = validate_hyp011_parent
    return module
...
def execute(workspace: Path) -> Path:
    ...
    if sha256_file(workspace / PLAN_REL) != PLAN_SHA256:
        raise WrapperError("HYP011 plan drifted")
...
def main() -> int:
    ...
    try:
        ...
        print(
            "EVENTAGGFLOW011_SOURCE_QUALITY_OK "
        ...
        print(
            f"EVENTAGGFLOW011_SOURCE_QUALITY_BLOCKED "
