...
# SOURCE QUALITY PLAN - HYP-EVENT-AGGFLOW-EURUSD-TICK-012

Frozen on 2026-08-12 after HYP011 preflight found that the reviewed HYP007
foundation required legacy usage-key names in the parent live plan, and before
any HYP010 trade-record side, size, or signed-flow distribution was read.
HYP012 is a fresh engineering successor: it keeps the identical transform,
population, gates, degraded-cell treatment, and sealed outcome boundary, while
explicitly validating HYP010 plan authorization flags and manifest/receipt usage
counters according to their actual schemas.
