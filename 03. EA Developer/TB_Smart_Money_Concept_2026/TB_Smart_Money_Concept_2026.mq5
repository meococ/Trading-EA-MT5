...
//|                                                                  |
//| Public iCustom buffer contract v2 (consume shift >= 1):          |
...
//|   43    Buffer contract version (= 2.0)                           |
//|                                                                  |
...
const double TB_CONTRACT_VERSION=2.0;
...
void ProcessClosedEngineBar(const int index,const double &open[],const double &high[],
                            const double &low[],const double &close[])
  {
   ...
   const bool tvProfile=(InpEngineProfile==TB_PROFILE_TV_2026_2_0);
