...
SOURCE = ROOT / "03. EA Developer/EA_SupertrendBurstScalperTrade/EA_SupertrendBurstScalperTrade.mq5"
TEXT = SOURCE.read_text(encoding="utf-8")


def test_fresh_trade_identity_is_hard_guarded() -> None:
    assert '"HYP-STBS-XAUUSD-M15-007"' in TEXT
    assert '"STBS_H1_FLIP_M15_BURST_TRADE_FSM_V1"' in TEXT
    assert "InpAuditOnly           = false" in TEXT
    assert "InpMagic               = 5604107" in TEXT
