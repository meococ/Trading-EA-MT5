#!/usr/bin/env python3
"""One-shot, timestamp-only execution-source builder for Round Cascade HYP006.
...
HYPOTHESIS_ID = "HYP-ROUND-CASCADE-EURUSD-M5-006"
PARENT_HYPOTHESIS_ID = "HYP-ROUND-CASCADE-EURUSD-M5-005"
...
PLAN_REL = (
    ...
    "HYP-ROUND-CASCADE-EURUSD-M5-006_EXECUTION_SOURCE_PLAN.md"
)
PLAN_SHA256 = "AB994DF9C613F1C4B47427D90F62A2999AF1CC36FD6DB21B5AE11BB111D4B1C1"
BUILDER_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/"
    "build_round_cascade_006_execution_source.py"
)
TEST_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/tests/"
    "test_build_round_cascade_006_execution_source.py"
)
REVIEW_RECEIPT_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/"
    "HYP-ROUND-CASCADE-EURUSD-M5-006_EXECUTION_SOURCE_IMPLEMENTATION_REVIEW_RECEIPT.json"
)
REVIEW_RECEIPT_SCHEMA = "round_cascade_006_execution_source_implementation_review.v1"
...
PARENT_TERMINAL_REL = (
    ...
    "HYP005-DESIGN-ECON-001/attempt_terminal.json"
)
PARENT_TERMINAL_SHA256 = "857C73EA9631D4BF8288E536A556BABDF083D2EBC67CA2C502DE647F00993830"
PARENT_STARTED_SHA256 = "73809C2AF2A445842A5AB5CC2F66D00169117749EBDC6DBF1692540729E41F98"
...
SUCCESS_ARTIFACT_ORDER = (
    "round_cascade_006_eligible_source_ledger.jsonl",
    "round_cascade_006_ineligible_source_ledger.jsonl",
    "round_cascade_006_execution_source_report.json",
...
def evaluate_stage0(
    ...
    *,
    ...
    report = {
        "schema_version": "round_cascade_006_execution_source_report.v1",
        "hypothesis_id": HYPOTHESIS_ID,
        "attempt_id": ATTEMPT_ID,
        "verdict": "PASS_EXECUTION_SOURCE_MAY_DRAFT_HYP007_DESIGN_ECONOMICS",
        ...
        "hyp007_drafting_authorized": True,
    }
...
def assert_outcome_blind(value: object) -> None:
    ...
    allowed_guard_keys = {"timestamp_only_outcome_blind"}
    forbidden_tokens = (
...
def expected_parent_terminal() -> dict[str, object]:
    return {
        ...
        "reason": "entry delay exceeds 60 minutes",
...
def validate_parent_terminal(payload: bytes) -> dict[str, object]:
    ...
    terminal = _json_load(payload, label="HYP005 parent terminal")
...
def validate_review_receipt(
    ...
    *,
    ...
    receipt = parse_canonical_object(payload, label="HYP006 review receipt")
...
def validate_public_metadata(
    ...
    *,
    ...
    receipt = parse_canonical_object(receipt_payload, label="public DESIGN receipt")
...
def reserve_attempt(workspace_root: Path, reviewed_row_sha256: str) -> tuple[Path, dict[str, str]]:
    ...
    started = {
        "schema_version": "round_cascade_006_attempt_started.v1",
        "hypothesis_id": HYPOTHESIS_ID,
        "attempt_id": ATTEMPT_ID,
        ...
        "design_manifest_sha256": M1_MANIFEST_SHA256,
        "design_receipt_sha256": M1_RECEIPT_SHA256,
        "permissions": {"timestamp_only": True, "hyp007_draft_only": True},
        "sealed_permissions": sealed_permissions(),
        "source_only_counters": executed_source_only_counters(),
    }
...
def load_public_timestamp_index(workspace_root: Path) -> tuple[TimestampIndex, dict[str, object]]:
    ...
    entries = validate_public_metadata(receipt_payload, manifest_payload)
    opened_bytes = 0
...
def persist_success(
    ...
    receipt = {
        "schema_version": "round_cascade_006_execution_source_receipt.v1",
        "hypothesis_id": HYPOTHESIS_ID,
        "attempt_id": ATTEMPT_ID,
    ...
    terminal = {
        ...
        "hypothesis_id": HYPOTHESIS_ID,
        "attempt_id": ATTEMPT_ID,
        "status": "PASS_EXECUTION_SOURCE_MAY_DRAFT_HYP007_DESIGN_ECONOMICS",
        "artifact_sha256": dict(artifact_hashes),
        "classification_sha256": result.classification_sha256,
        "promotion_evidence": False,
        "hyp007_drafting_authorized": True,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"HYP006_EXECUTION_SOURCE_ERROR {exc}", file=sys.stderr)
        return 2
