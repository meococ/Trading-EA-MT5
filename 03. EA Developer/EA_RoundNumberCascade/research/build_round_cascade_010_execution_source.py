#!/usr/bin/env python3
"""One-shot, timestamp-only execution-source builder for Round Cascade HYP010.

Implementation/source-contract refinement child of engineering-invalid HYP009.
Importing this module is inert. A production read requires both the explicit
...
The sole intentional delta from HYP008 is the deterministic time-only
classifier prerequisite order: exact observed M1, then complete M5 at planned
(before refractory), then refractory, then ELIGIBLE_EXACT_COMPLETE_M5_NONOVERLAP
with arm-local reservation. Failed prerequisite rows never reserve state.
This is not a market-rule or economic rescue; HYP009 emitted no trades.
"""
...
HYPOTHESIS_ID = "HYP-ROUND-CASCADE-EURUSD-M5-010"
PARENT_HYPOTHESIS_ID = "HYP-ROUND-CASCADE-EURUSD-M5-009"
...
ATTEMPT_ID = "HYP010-EXEC-SOURCE-001"
...
PLAN_SHA256 = "7147C4CE9736129BD503606E445F2460561BDDD0B665EB79F6D8FCDC5C7A5928"
BUILDER_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/"
    "build_round_cascade_010_execution_source.py"
)
TEST_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/tests/"
    "test_build_round_cascade_010_execution_source.py"
)
REVIEW_RECEIPT_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/"
    "HYP-ROUND-CASCADE-EURUSD-M5-010_EXECUTION_SOURCE_IMPLEMENTATION_REVIEW_RECEIPT.json"
)
REVIEW_RECEIPT_SCHEMA = "round_cascade_010_execution_source_implementation_review.v1"
...
PARENT_TERMINAL_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/evidence/"
    "HYP-ROUND-CASCADE-EURUSD-M5-009_DESIGN_ECONOMICS/"
    "HYP009-DESIGN-ECON-001/attempt_terminal.json"
)
PARENT_TERMINAL_SHA256 = "5F13B1F51CD7B5A2266640AF17633531F9B16E5D43FB8345DF90B5144A1EC7C7"
PARENT_STARTED_SHA256 = "7692DF408BE6D52A201904D6DB895E5E7387FD99EDAA519D128CE2566DED720D"

# Exact HYP008 PASS chain (prior successful timestamp-only execution source).
HYP008_ATTEMPT_ID = "HYP008-EXEC-SOURCE-001"
HYP008_HYPOTHESIS_ID = "HYP-ROUND-CASCADE-EURUSD-M5-008"
HYP008_PASS_VERDICT = "PASS_EXECUTION_SOURCE_MAY_DRAFT_HYP009_DESIGN_ECONOMICS"
HYP008_EVIDENCE_ROOT_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/evidence/"
    "HYP-ROUND-CASCADE-EURUSD-M5-008_EXECUTION_SOURCE/"
    f"{HYP008_ATTEMPT_ID}"
)
HYP008_TERMINAL_REL = f"{HYP008_EVIDENCE_ROOT_REL}/attempt_terminal.json"
HYP008_TERMINAL_SHA256 = "9EFA0811D46286A2B5FCBBADB814785BA5EC24EC83A90DC73CD998394EBD8E10"
HYP008_RECEIPT_REL = f"{HYP008_EVIDENCE_ROOT_REL}/execution_source_receipt.json"
HYP008_RECEIPT_SHA256 = "A06E602222E20C7B1800F3E92FFA51679A6DDB06D9DE81FC41CF737C9D0B8DF9"
HYP008_REPORT_REL = f"{HYP008_EVIDENCE_ROOT_REL}/round_cascade_008_execution_source_report.json"
HYP008_REPORT_SHA256 = "5F74F6A33FA66D05D131D5727CC6CC31929C748A8B223A820986FD62CD180EEA"
HYP008_ELIGIBLE_LEDGER_REL = (
    f"{HYP008_EVIDENCE_ROOT_REL}/round_cascade_008_eligible_source_ledger.jsonl"
)
HYP008_ELIGIBLE_LEDGER_SHA256 = (
    "B84EF3925B5CC998A88D224BCF8B4A66D5A6076DFED87C4287325F369AAFF16B"
)
HYP008_INELIGIBLE_LEDGER_REL = (
    f"{HYP008_EVIDENCE_ROOT_REL}/round_cascade_008_ineligible_source_ledger.jsonl"
)
HYP008_INELIGIBLE_LEDGER_SHA256 = (
    "9C48A22BAEF82998038D9D24472A61863AD9DD8BBFF9BD9D52C5C0E66C2E6680"
)
HYP008_CLASSIFICATION_SHA256 = (
    "97D0CB0FF8E471C961032206B11BC4B6E9ACB0DD13B99ECBED655C064D28F82D"
)
# Forensic-only expectation from HYP008 PASS eligible ledger diagnosis.
# Not a fatal production Stage-0 constant.
FORENSIC_NO_COMPLETE_M5_AT_PLANNED_EXPECTATION = {
    "TRUE_0050": 2,
    "SHIFTED_0025": 1,
}
...
AUTHORITY_BINDING_FIELDS = {
    ...
    "hyp008_terminal_path", "hyp008_terminal_sha256",
    "hyp008_classification_sha256", "hyp008_eligible_ledger_sha256",
}
...
SUCCESS_ARTIFACT_ORDER = (
    "round_cascade_010_eligible_source_ledger.jsonl",
    "round_cascade_010_ineligible_source_ledger.jsonl",
    "round_cascade_010_execution_source_report.json",
    "execution_source_receipt.json",
    "attempt_terminal.json",
)

PASS_VERDICT = "PASS_EXECUTION_SOURCE_MAY_DRAFT_HYP011_DESIGN_ECONOMICS"
ELIGIBLE_STATUS = "ELIGIBLE_EXACT_COMPLETE_M5_NONOVERLAP"
NO_COMPLETE_STATUS = "NO_COMPLETE_M5_AT_PLANNED"
...
def _delay_minutes(later: datetime | None, earlier: datetime) -> int | float | None:
    if later is None:
        return None
    delay = (later - earlier).total_seconds() / 60.0
...
def classify_sources(
    ...
    """Arm-local greedy classifier with exact-complete-M5 prerequisites.

    Order is mandatory: (1) NO_EXACT_ENTRY, (2) NO_COMPLETE_M5_AT_PLANNED or
    fail-closed right-edge incomplete horizon, (3) REFRACTORY_INELIGIBLE,
    (4) ELIGIBLE_EXACT_COMPLETE_M5_NONOVERLAP. Prerequisites never reserve.
    """
                ...
                ineligible.append(
                    {
                        ...
                        "delay_minutes": _delay_minutes(next_observed, planned),
                    }
                )
                continue
            while m5_ordinal < len(m5) and m5[m5_ordinal] < planned:
                m5_ordinal += 1
            complete_at_planned = m5_ordinal < len(m5) and m5[m5_ordinal] == planned
            if not complete_at_planned:
                next_m5 = m5[m5_ordinal] if m5_ordinal < len(m5) else None
                ineligible.append(
                    {
                        "arm": arm,
                        "source_identity": identity,
                        ...
                        "next_complete_m5_start_utc": iso_z(next_m5) if next_m5 else None,
                        "delay_minutes": _delay_minutes(next_m5, planned),
                    }
                )
                continue
...
def replay_sources_independently(
    ...
    for arm in ARM_ORDER:
        ...
        for raw in sources_by_arm[arm]:
            ...
            complete_at_planned = (
                horizon_ordinal < len(timestamp_index.complete_m5_starts)
                and timestamp_index.complete_m5_starts[horizon_ordinal] == planned
            )
            if not complete_at_planned:
                next_m5 = (
                    timestamp_index.complete_m5_starts[horizon_ordinal]
                    if horizon_ordinal < len(timestamp_index.complete_m5_starts) else None
                )
                ineligible.append(
                    {
                        "arm": arm, "source_identity": identity,
...
def _actual_counts(result: ClassificationResult) -> dict[str, dict[str, int]]:
    counts = {
        ...
        for status in (
            ELIGIBLE_STATUS, "REFRACTORY_INELIGIBLE", "NO_EXACT_ENTRY", NO_COMPLETE_STATUS
        )
    }
...
def evaluate_stage0(
    ...
    *,
    ...
    for row in result.eligible:
        ...
        if m5_ordinal >= len(m5) or m5[m5_ordinal] != planned:
            raise ContractError("eligible row lacks complete M5 at planned")
        horizon = m5[m5_ordinal : m5_ordinal + 12]
        if len(horizon) != 12:
        ...
        if row.get("status") != ELIGIBLE_STATUS:
            raise ContractError("eligible status mismatch")
    ...
    report = {
        ...
        "forensic_no_complete_m5_at_planned_expectation": dict(
            FORENSIC_NO_COMPLETE_M5_AT_PLANNED_EXPECTATION
        ),
        "gates": gates,
        ...
        "hyp008_pass_chain": {
            "hypothesis_id": HYP008_HYPOTHESIS_ID,
            "attempt_id": HYP008_ATTEMPT_ID,
            "terminal_sha256": HYP008_TERMINAL_SHA256,
            "receipt_sha256": HYP008_RECEIPT_SHA256,
            "report_sha256": HYP008_REPORT_SHA256,
            "eligible_ledger_sha256": HYP008_ELIGIBLE_LEDGER_SHA256,
            "ineligible_ledger_sha256": HYP008_INELIGIBLE_LEDGER_SHA256,
            "classification_sha256": HYP008_CLASSIFICATION_SHA256,
            "verdict": HYP008_PASS_VERDICT,
        },
    }
...
def assert_outcome_blind(value: object) -> None:
    allowed_entry_exit_keys = {
        ...
        "ELIGIBLE_EXACT_ENTRY_NONOVERLAP", ELIGIBLE_STATUS, "NO_EXACT_ENTRY",
        NO_COMPLETE_STATUS, "next_complete_m5_start_utc",
    }
    allowed_guard_keys = {
        "timestamp_only_outcome_blind",
        "historical_design_receipt_sha_bound_object_equal",
        "canonical_design_manifest_sha_bound",
        "eligible_complete_m5_at_planned",
        "prerequisite_before_refractory",
        "hyp008_pass_chain_bound",
    }
    forbidden_tokens = (
...
def validate_parent_terminal(payload: bytes) -> dict[str, object]:
    ...
    terminal = _json_load(payload, label="HYP009 parent terminal")
    if type(terminal) is not dict or terminal != expected_parent_terminal():
        raise ContractError("parent terminal object mismatch")
    return terminal


def expected_hyp008_pass_chain_bindings() -> dict[str, str]:
    return {
        "terminal_path": HYP008_TERMINAL_REL,
        "terminal_sha256": HYP008_TERMINAL_SHA256,
        "receipt_path": HYP008_RECEIPT_REL,
        "receipt_sha256": HYP008_RECEIPT_SHA256,
        "report_path": HYP008_REPORT_REL,
        "report_sha256": HYP008_REPORT_SHA256,
        "eligible_ledger_path": HYP008_ELIGIBLE_LEDGER_REL,
        "eligible_ledger_sha256": HYP008_ELIGIBLE_LEDGER_SHA256,
        "ineligible_ledger_path": HYP008_INELIGIBLE_LEDGER_REL,
        "ineligible_ledger_sha256": HYP008_INELIGIBLE_LEDGER_SHA256,
        "classification_sha256": HYP008_CLASSIFICATION_SHA256,
        "verdict": HYP008_PASS_VERDICT,
    }
...
def validate_hyp008_pass_chain_bytes(
    *,
    terminal_payload: bytes,
    receipt_payload: bytes,
    report_payload: bytes,
    eligible_payload: bytes,
    ineligible_payload: bytes,
) -> None:
    bindings = expected_hyp008_pass_chain_bindings()
    pairs = (
        (terminal_payload, bindings["terminal_sha256"], "HYP008 terminal"),
        (receipt_payload, bindings["receipt_sha256"], "HYP008 receipt"),
        (report_payload, bindings["report_sha256"], "HYP008 report"),
        (eligible_payload, bindings["eligible_ledger_sha256"], "HYP008 eligible ledger"),
        (ineligible_payload, bindings["ineligible_ledger_sha256"], "HYP008 ineligible ledger"),
    )
    for payload, expected, label in pairs:
        if sha256_bytes(payload) != expected:
            raise ContractError(f"{label} SHA binding mismatch")
    terminal = _json_load(terminal_payload, label="HYP008 terminal")
    if type(terminal) is not dict:
        raise ContractError("HYP008 terminal is not an object")
    if (
        terminal.get("hypothesis_id") != HYP008_HYPOTHESIS_ID
        or terminal.get("attempt_id") != HYP008_ATTEMPT_ID
        or terminal.get("status") != HYP008_PASS_VERDICT
        or terminal.get("classification_sha256") != HYP008_CLASSIFICATION_SHA256
        or terminal.get("hyp009_drafting_authorized") is not True
    ):
        raise ContractError("HYP008 terminal object mismatch")
...
def validate_review_receipt(
    ...
    *,
    ...
    receipt = parse_canonical_object(payload, label="HYP010 review receipt")
...
def _expected_authority_bindings(builder_payload: bytes, test_payload: bytes) -> dict[str, object]:
    return {
        ...
        "hyp008_terminal_path": HYP008_TERMINAL_REL,
        "hyp008_terminal_sha256": HYP008_TERMINAL_SHA256,
        "hyp008_classification_sha256": HYP008_CLASSIFICATION_SHA256,
        "hyp008_eligible_ledger_sha256": HYP008_ELIGIBLE_LEDGER_SHA256,
    }
...
def reserve_attempt(workspace_root: Path, reviewed_row_sha256: str) -> tuple[Path, dict[str, str]]:
    ...
    started = {
        "schema_version": "round_cascade_010_attempt_started.v1",
        "hypothesis_id": HYPOTHESIS_ID,
        "attempt_id": ATTEMPT_ID,
        ...
        "parent_terminal_sha256": PARENT_TERMINAL_SHA256,
        "hyp008_terminal_sha256": HYP008_TERMINAL_SHA256,
        "permissions": {"timestamp_only": True, "hyp011_draft_only": True},
        "sealed_permissions": sealed_permissions(),
        "source_only_counters": executed_source_only_counters(),
    }
    ...
    def timestamp_rows() -> Iterable[dict[str, object]]:
        ...
        for entry in entries:
            ...
            if len(rows) != entry["rows"]:
                raise ContractError("manifest-bound public DESIGN shard row count mismatch")
            for row in rows:
                value = row["time_utc"]
...
def persist_success(
    ...
    receipt = {
        "schema_version": "round_cascade_010_execution_source_receipt.v1",
        "hypothesis_id": HYPOTHESIS_ID,
        "attempt_id": ATTEMPT_ID,
    ...
    terminal = {
        "schema_version": "round_cascade_010_attempt_terminal.v1",
        "hypothesis_id": HYPOTHESIS_ID,
        "attempt_id": ATTEMPT_ID,
        "status": PASS_VERDICT,
        "artifact_sha256": dict(artifact_hashes),
...
def persist_engineering_failure(root: Path, artifact_hashes: dict[str, str], exc: Exception) -> None:
    ...
    terminal = {
        ...
        "artifact_sha256": dict(artifact_hashes),
        "promotion_evidence": False,
        "hyp011_drafting_authorized": False,
        "sealed_permissions": sealed_permissions(),
        "source_only_counters": executed_source_only_counters(),
    }
...
def execute_probe(*, workspace_root: Path, run_switch: bool) -> dict[str, object]:
    ...
    validate_hyp008_pass_chain_bytes(
        terminal_payload=stable_read_regular(workspace_file(workspace, HYP008_TERMINAL_REL), workspace),
        receipt_payload=stable_read_regular(workspace_file(workspace, HYP008_RECEIPT_REL), workspace),
        report_payload=stable_read_regular(workspace_file(workspace, HYP008_REPORT_REL), workspace),
        eligible_payload=stable_read_regular(workspace_file(workspace, HYP008_ELIGIBLE_LEDGER_REL), workspace),
        ineligible_payload=stable_read_regular(
            workspace_file(workspace, HYP008_INELIGIBLE_LEDGER_REL), workspace
        ),
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"HYP010_EXECUTION_SOURCE_ERROR {exc}", file=sys.stderr)
        return 2
