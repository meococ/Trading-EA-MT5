...
import build_round_cascade_001_source_v2 as sut
...
def test_float_representation_noise_does_not_reject_valid_quote_grid_price() -> None:
...
def test_import_is_inert(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(sys, "argv", ["build_round_cascade_001_source.py", "--run-reviewed-stage0"])
    spec = importlib.util.spec_from_file_location("round_cascade_inert_copy", RESEARCH_DIR / "build_round_cascade_001_source.py")
