...
BUILDER_REL = "03. EA Developer/EA_RoundNumberCascade/research/build_round_cascade_001_source_v2.py"
TEST_REL = "03. EA Developer/EA_RoundNumberCascade/research/tests/test_build_round_cascade_001_source_v2.py"
...
ATTEMPT_ID = "HYP001-SOURCE-PREFLIGHT-002"
EVIDENCE_ROOT_REL = (
...
FLOAT_QUOTE_POINT_TOLERANCE = Decimal("0.000001")
POINTS_PER_PIP = 10
...
def price_to_points(price: Any) -> int:
    ...
    integral_points = points.to_integral_value()
    if points != integral_points:
        if isinstance(price, float) and abs(points - integral_points) <= FLOAT_QUOTE_POINT_TOLERANCE:
            return int(integral_points)
