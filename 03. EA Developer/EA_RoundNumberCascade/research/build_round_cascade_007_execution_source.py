#!/usr/bin/env python3
"""One-shot, timestamp-only execution-source builder for Round Cascade HYP007.

Implementation-repair child of engineering-invalid HYP006. Importing this
...
The sole intentional delta from HYP006 is SHA-bound historical public DESIGN
receipt parsing: duplicate-safe / nonfinite-safe JSON object parse plus exact
expected-object equality, without requiring canonical byte serialization of
the receipt. The 1,555-line DESIGN manifest remains canonical LF JSONL and
exact SHA-bound. This is not a market-rule or Stage-0 rescue.
"""
...
HYPOTHESIS_ID = "HYP-ROUND-CASCADE-EURUSD-M5-007"
PARENT_HYPOTHESIS_ID = "HYP-ROUND-CASCADE-EURUSD-M5-006"
...
PLAN_REL = (
    ...
    "HYP-ROUND-CASCADE-EURUSD-M5-007_EXECUTION_SOURCE_REPAIR_PLAN.md"
)
PLAN_SHA256 = "038A0BA3DA6572385CCE1FAB2AA61A5249A4B49A425A82E9330F9E41C85A7229"
BUILDER_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/"
    "build_round_cascade_007_execution_source.py"
)
TEST_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/tests/"
    "test_build_round_cascade_007_execution_source.py"
)
REVIEW_RECEIPT_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/"
    "HYP-ROUND-CASCADE-EURUSD-M5-007_EXECUTION_SOURCE_IMPLEMENTATION_REVIEW_RECEIPT.json"
)
REVIEW_RECEIPT_SCHEMA = "round_cascade_007_execution_source_implementation_review.v1"
...
PARENT_TERMINAL_REL = (
    "03. EA Developer/EA_RoundNumberCascade/research/evidence/"
    "HYP-ROUND-CASCADE-EURUSD-M5-006_EXECUTION_SOURCE/"
    "HYP006-EXEC-SOURCE-001/attempt_terminal.json"
)
PARENT_TERMINAL_SHA256 = "9608F9C4F88A9583C5FD5674E3FF22C7AD0F308E158EFF3BF903D58FF77740B8"
PARENT_STARTED_SHA256 = "3BA43183DBA066FFAE4BDF4055F973D3FEF1D6EE5E34700EE58AEC790661689E"
...
SUCCESS_ARTIFACT_ORDER = (
    "round_cascade_007_eligible_source_ledger.jsonl",
    "round_cascade_007_ineligible_source_ledger.jsonl",
    "round_cascade_007_execution_source_report.json",
    "execution_source_receipt.json",
    "attempt_terminal.json",
)

PASS_VERDICT = "PASS_EXECUTION_SOURCE_MAY_DRAFT_HYP008_DESIGN_ECONOMICS"
...
def evaluate_stage0(
    ...
    *,
    ...
    report = {
        "schema_version": "round_cascade_007_execution_source_report.v1",
        ...
        "hyp008_drafting_authorized": True,
    }
...
def expected_parent_terminal() -> dict[str, object]:
    return {
        ...
        "attempt_id": "HYP006-EXEC-SOURCE-001",
        "hyp007_drafting_authorized": False,
        "hypothesis_id": PARENT_HYPOTHESIS_ID,
        "promotion_evidence": False,
        "reason": {
            "message": "public DESIGN receipt is not one canonical JSON object",
            "type": "ContractError",
        },
        "schema_version": "round_cascade_006_attempt_terminal.v1",
        "sealed_permissions": sealed_permissions(),
...
def validate_parent_terminal(payload: bytes) -> dict[str, object]:
    ...
    terminal = _json_load(payload, label="HYP006 parent terminal")
...
def validate_review_receipt(
    ...
    *,
    ...
    receipt = parse_canonical_object(payload, label="HYP007 review receipt")
...
def reserve_attempt(workspace_root: Path, reviewed_row_sha256: str) -> tuple[Path, dict[str, str]]:
    ...
    started = {
        "schema_version": "round_cascade_007_attempt_started.v1",
        "hypothesis_id": HYPOTHESIS_ID,
        "attempt_id": ATTEMPT_ID,
        ...
        "design_manifest_sha256": M1_MANIFEST_SHA256,
        "design_receipt_sha256": M1_RECEIPT_SHA256,
        "permissions": {"timestamp_only": True, "hyp008_draft_only": True},
        "sealed_permissions": sealed_permissions(),
        "source_only_counters": executed_source_only_counters(),
    }
...
def load_public_timestamp_index(workspace_root: Path) -> tuple[TimestampIndex, dict[str, object]]:
    ...
    return index, {
        "design_shards_opened": len(entries),
        "design_timestamp_rows_read": len(index.observed_m1),
        "design_bytes_opened": opened_bytes,
    }
...
def persist_success(
    ...
    receipt = {
        "schema_version": "round_cascade_007_execution_source_receipt.v1",
        "hypothesis_id": HYPOTHESIS_ID,
        "attempt_id": ATTEMPT_ID,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"HYP007_EXECUTION_SOURCE_ERROR {exc}", file=sys.stderr)
        return 2
