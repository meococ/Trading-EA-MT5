...
$hypothesisId = "HYP-RSF-EURUSD-M5-ROLE-AWARE-VISUAL-004-$Case"
...
$preregPath = Join-Path $repoRoot '03. EA Developer\EA_RegimeStructureFusionForensics\research\HYP-RSF-EURUSD-M5-ROLE-AWARE-VISUAL-004_FROZEN_PREREG.md'
...
$receipt = [ordered]@{
    ...
    note = 'One-case short-window paired native MT5 visual replay. Diagnostic Model1 only; all generated performance numbers have no economic authority.'
}
