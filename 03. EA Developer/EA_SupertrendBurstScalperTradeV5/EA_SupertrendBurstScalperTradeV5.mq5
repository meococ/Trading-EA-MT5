...
#property description "H1 Supertrend flip with account-compatible margin safety and bounded audit evidence."

input string InpHypothesisId        = "HYP-STBS-XAUUSD-M15-016";
input string InpVariantTag          = "STBS_H1_FLIP_M15_BURST_AUDIT_V5_ACCOUNT_SAFE";
input bool   InpAuditOnly           = false;
input bool   InpEnableTelemetry     = false;
input long   InpMagic               = 5604116;
...
const string EA_NAME              = "EA_SupertrendBurstScalperTradeV5";
...
int OnInit()
{
   if(!MQLInfoInteger(MQL_TESTER) || MQLInfoInteger(MQL_OPTIMIZATION) ||
      _Symbol!="XAUUSD" || _Period!=PERIOD_M15 ||
       InpHypothesisId!="HYP-STBS-XAUUSD-M15-016" ||
       InpVariantTag!="STBS_H1_FLIP_M15_BURST_AUDIT_V5_ACCOUNT_SAFE" ||
       !InpAuditOnly || InpEnableTelemetry || InpMagic!=5604116 ||
