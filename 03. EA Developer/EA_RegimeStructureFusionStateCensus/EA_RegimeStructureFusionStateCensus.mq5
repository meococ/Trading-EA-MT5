...
// every trading route and exports one discovery row per completed M5 bar.
...
void ExportCensusClosedBar()
  {
   ...
   FileWrite(g_census_handle,
      ...
      DoubleToString(iOpen(_Symbol,PERIOD_M5,1),_Digits),DoubleToString(iHigh(_Symbol,PERIOD_M5,1),_Digits),
      DoubleToString(iLow(_Symbol,PERIOD_M5,1),_Digits),DoubleToString(iClose(_Symbol,PERIOD_M5,1),_Digits),DoubleToString(spread_points,2),
