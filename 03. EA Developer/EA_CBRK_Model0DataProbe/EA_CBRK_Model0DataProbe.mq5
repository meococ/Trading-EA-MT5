//+------------------------------------------------------------------+
//| EA_CBRK_Model0DataProbe.mq5                                        |
//| CBRK Model-0 exact-window data-quality probe.                       |
//| No trading, no file writes, no telemetry sidecars.                |
//+------------------------------------------------------------------+
#property copyright "AlphaFactory research"
#property version   "1.00"
#property strict
#property description "CBRK Model-0 exact-window data-quality probe; no trading"

input string          InpHypothesisId="";
input string          InpGenerationId="CBRK-DQ003";
input string          InpEpochManifestSha256="ACF4E34FC3885EA00CD776DF73B54EB676952E0F39955CD346591F61B43440F5";
...
public:
   ...
   bool Configure(
   ...
   )
     {
      ...
      if(m_generation_id!="CBRK-DQ003")
        {
         PrintFormat("DATA_EPOCH_D0_INIT_FAIL reason=wrong_generation_id generation_id=%s",m_generation_id);
         return false;
        }
      if(m_epoch_manifest_sha256!="ACF4E34FC3885EA00CD776DF73B54EB676952E0F39955CD346591F61B43440F5" ||
