...
EA_SOURCE = PACKAGE / "EA_XBTMMTradeThroughV3.mq5"
PREREG = PACKAGE / "research" / "HYP-XBT-MM-TRADETHROUGH-003_FROZEN_DESIGN_PREREG.md"
...
def test_current_preflight_and_prereg_keep_future_splits_sealed() -> None:
    manifest_path = PACKAGE / "research" / "preflight" / "HYP-XBT-MM-TRADETHROUGH-003" / "20180101_event_manifest.json"
