...
#property description "Production-state H1 Supertrend flip with idempotent durable lifecycle."

input string InpHypothesisId        = "HYP-STBS-XAUUSD-M15-009";
input string InpVariantTag          = "STBS_H1_FLIP_M15_BURST_TRADE_FSM_V2";
input bool   InpAuditOnly           = false;
input bool   InpEnableTelemetry     = false;
input long   InpMagic               = 5604109;
...
int OnInit()
{
   if(!MQLInfoInteger(MQL_TESTER) || MQLInfoInteger(MQL_OPTIMIZATION) ||
      ...
      InpHypothesisId!="HYP-STBS-XAUUSD-M15-009" ||
      InpVariantTag!="STBS_H1_FLIP_M15_BURST_TRADE_FSM_V2" ||
      InpEnableTelemetry || InpMagic!=5604109 ||
