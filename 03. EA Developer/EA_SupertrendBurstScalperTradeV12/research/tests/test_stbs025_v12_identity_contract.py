...
V11 = ROOT / "03. EA Developer/EA_SupertrendBurstScalperTradeV11/EA_SupertrendBurstScalperTradeV11.mq5"
V12 = PACKAGE / "EA_SupertrendBurstScalperTradeV12.mq5"
FAILURE_ARCHIVE = (
    ROOT
...
COST_MANIFEST = PACKAGE / "research/HYP-STBS-XAUUSD-M15-025_RESEARCH_COST_SOURCE_MANIFEST.json"
...
def normalize_v11_to_v12(text: str) -> str:
    replacements = {
        '#property version   "11.00"': '#property version   "12.00"',
        ...
        "HYP-STBS-XAUUSD-M15-024": "HYP-STBS-XAUUSD-M15-025",
        "STBS_H1_FLIP_M15_BURST_TRADE_V11_COMPACT_MARGIN_TELEMETRY":
            "STBS_H1_FLIP_M15_BURST_TRADE_V12_IDENTITY_CLONE",
        "5604124": "5604125",
        "EA_SupertrendBurstScalperTradeV11": "EA_SupertrendBurstScalperTradeV12",
    }
...
def test_v12_is_exact_v11_identity_only_clone():
    assert normalize_v11_to_v12(V11.read_text(encoding="utf-8")) == V12.read_text(encoding="utf-8")
    assert sha256(V11) == "7CC7A9D7C30216A1669D84AEEA867E32EA15F2E9E8C195D171BD574A4D2EB0BC"
    assert sha256(V12) == "D96F55A26F277CFC3FDC4E23A11A84C74598C111639E629CEC1877AC3F7704C5"


def test_v12_identity_is_fail_closed():
...
def test_nondecision_spam_remains_absent():
    assert "STBS_MARGIN_STRESS_UNSAFE" not in V12.read_text(encoding="utf-8")


def test_generic_cost_builder_accepts_same_outer_inner_identity_and_rejects_adapter(tmp_path: Path):
    spec = importlib.util.spec_from_file_location("stbs025_cost_builder", COST_BUILDER)
    ...
    payload = {
        ...
        "variant_tag": "STBS_H1_FLIP_M15_BURST_TRADE_V12_IDENTITY_CLONE",
        "magic": 5604125,
        "audit_only": False,
    ...
    bad_contract = dict(contract, hypothesis_id="HYP-STBS-XAUUSD-M15-024")
...
def test_execute_claim_precedes_first_bound_helper_read_and_failure_is_terminal(tmp_path: Path):
    ...
    packet_relative = (
        "03. EA Developer/EA_SupertrendBurstScalperTradeV12/research/preflight/"
        "HYP-STBS-XAUUSD-M15-025/V1/task_packet.control.json"
    )
    row = {
        "hypothesis_id": "HYP-STBS-XAUUSD-M15-025",
        "state": "screened",
    ...
    command = [
        ...
        "-EaName", "EA_SupertrendBurstScalperTradeV12",
        "-HypothesisId", "HYP-STBS-XAUUSD-M15-025",
    ...
    attempt = isolated / (
        ...
        "HYP-STBS-XAUUSD-M15-025/STBS025-MODEL0-TRAIN-001"
    )
