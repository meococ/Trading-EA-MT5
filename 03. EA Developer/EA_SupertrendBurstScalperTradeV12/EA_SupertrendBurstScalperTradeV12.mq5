...
input string InpHypothesisId        = "HYP-STBS-XAUUSD-M15-025";
input string InpVariantTag          = "STBS_H1_FLIP_M15_BURST_TRADE_V12_IDENTITY_CLONE";
input bool   InpAuditOnly           = false;
input bool   InpEnableTelemetry     = true;
input long   InpMagic               = 5604125;
...
const string EA_NAME              = "EA_SupertrendBurstScalperTradeV12";
...
int OnInit()
{
   if(!MQLInfoInteger(MQL_TESTER) || MQLInfoInteger(MQL_OPTIMIZATION) ||
      _Symbol!="XAUUSD" || _Period!=PERIOD_M15 ||
       InpHypothesisId!="HYP-STBS-XAUUSD-M15-025" ||
       InpVariantTag!="STBS_H1_FLIP_M15_BURST_TRADE_V12_IDENTITY_CLONE" ||
       InpAuditOnly || !InpEnableTelemetry || InpMagic!=5604125 ||
