...
const string HYPOTHESIS_ID="HYP-UPS-XAU-M5-002";
...
bool WriteRunMeta()
  {
   ...
   int handle=FileOpen(g_run_meta_name,FILE_WRITE|FILE_TXT|FILE_ANSI|FILE_COMMON);
...
bool OpenLifecycleTelemetry()
  {
   ...
   g_telemetry_handle=FileOpen(g_lifecycle_name,FILE_WRITE|FILE_CSV|FILE_ANSI|FILE_COMMON,',');
