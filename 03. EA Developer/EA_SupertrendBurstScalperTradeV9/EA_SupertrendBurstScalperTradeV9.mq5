...
input string InpHypothesisId        = "HYP-STBS-XAUUSD-M15-022";
input string InpVariantTag          = "STBS_H1_FLIP_M15_BURST_TRADE_V9_SL_STRESSED_MARGIN";
input bool   InpAuditOnly           = false;
input bool   InpEnableTelemetry     = true;
input long   InpMagic               = 5604122;
...
const string EA_NAME              = "EA_SupertrendBurstScalperTradeV9";
...
int OnInit()
{
   if(!MQLInfoInteger(MQL_TESTER) || MQLInfoInteger(MQL_OPTIMIZATION) ||
      _Symbol!="XAUUSD" || _Period!=PERIOD_M15 ||
       InpHypothesisId!="HYP-STBS-XAUUSD-M15-022" ||
       InpVariantTag!="STBS_H1_FLIP_M15_BURST_TRADE_V9_SL_STRESSED_MARGIN" ||
       InpAuditOnly || !InpEnableTelemetry || InpMagic!=5604122 ||
