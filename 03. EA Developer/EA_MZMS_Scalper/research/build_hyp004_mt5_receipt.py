#!/usr/bin/env python3
"""Build hash-bound manual AlphaFactory receipts for MZMS HYP-004."""
...
HYPOTHESIS_ID = "HYP-MZMS-MACD-HIST-SLOPE-EURUSD-M5-004"
...
def build(role: str, control_run: Path | None) -> tuple[Path, str]:
    ...
    receipt = {
        ...
        "note": (
            "Owner-directed 2018-YTD MZMS diagnostic. News guard is disabled "
