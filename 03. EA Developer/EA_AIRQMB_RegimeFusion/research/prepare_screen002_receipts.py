...
PREREG = PACKAGE / "research" / "HYP-AIRQMB-MULTI9-M5-SCREEN-002_FROZEN_PREREG.md"
EA_CONTRACT = PACKAGE / "ALPHAFACTORY_EA_CONTRACT.json"
MANIFEST = PACKAGE / "research" / "screen002_receipts_manifest.json"
SOURCE_SHA256 = "07D94050A8142353E6E0DD491334CED5631E3B0EF12011B8119AD92A28208B52"
...
def effective_overrides(symbol: str, magic: int) -> str:
    values = {
        ...
        "InpHypothesisId": f"HYP-AIRQMB-{symbol}-M5-SCREEN-002",
        "InpMagic": str(magic),
        "InpResearchAutoMode": "true",
        "InpVariantTag": "SCREEN002_MODEL4",
    }
...
def main() -> None:
    if sha256_file(SOURCE) != SOURCE_SHA256:
        raise SystemExit("SCREEN-002 source changed")
    ...
    for symbol, magic, geometry in CELLS:
        hypothesis_id = f"HYP-AIRQMB-{symbol}-M5-SCREEN-002"
        raw_row, row = latest[hypothesis_id]
        if row.get("verdict") != "PREREGISTERED_MODEL4_SCREEN_NOT_RUN":
        ...
        cost = {
            ...
            "provenance_status": "MODEL4_SCREEN_CURRENT_SPREAD_ONLY",
    ...
    for prepared_cell in prepared:
        ...
        receipt_path = RUNTIME / f"ea_execution_receipt_airqmb_{symbol.lower()}_screen002.json"
        receipt = {
    ...
    MANIFEST.write_text(json.dumps({
        "schema_version": "airqmb_screen002_receipts.v1", "git_commit": commit,
