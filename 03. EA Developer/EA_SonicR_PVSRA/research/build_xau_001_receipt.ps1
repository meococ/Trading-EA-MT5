param(
    ...
    [string]$HypothesisId = 'HYP-SONICR-XAU-M15-RECLAIM-TTL-001',
    [string]$Symbol = 'XAUUSD',
    [string]$Period = 'M15',
    [int]$Digits = 2,
    [double]$Point = 0.01,
    [double]$PipSize = 0.01,
    [string]$Overrides = 'InpHypothesisId=HYP-SONICR-XAU-M15-RECLAIM-TTL-001;InpMagic=16081710;InpMaxPullbackAge=1;InpMaxSpreadPoints=500;InpMaxTradesPerWeek=3;InpMinTpPips=2000;InpNyEndHour=17;InpOffsetPoints=50;InpPendingTtlBars=32;InpPipSize=0.01;InpRoundWhole=10.0;InpSlCapPips=2000;InpUseNySession=true;InpVariantTag=XAU_RECLAIM_TTL'
)
