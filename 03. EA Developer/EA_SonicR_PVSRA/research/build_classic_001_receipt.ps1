param(
    ...
    [string]$HypothesisId = 'HYP-SONICR-CLASSIC-EURUSD-M15-001',
    [string]$Symbol = 'EURUSD',
    [int]$Digits = 5,
    [double]$Point = 0.00001,
    [double]$PipSize = 0.0001,
    [string]$Overrides = 'InpHypothesisId=HYP-SONICR-CLASSIC-EURUSD-M15-001;InpVariantTag=CLASSIC_WAVE_LEG3'
)
...
$receipt = [ordered]@{
    ...
    note = 'Tester-only Model-0 on MetaQuotes-Demo portable. Registry bound read-only; not appended. MQ Demo != FivePercent. Friday flat 20:00. Not live-equivalent.'
}
