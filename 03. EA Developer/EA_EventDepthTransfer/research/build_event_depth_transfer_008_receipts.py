"""Build frozen AlphaFactory HYP008 PRIMARY/REVERSE packets and receipts."""
...
PREFLIGHT = RESEARCH / "preflight/HYP-EVENT-DEPTH-TRANSFER-EURUSD-TICK-008"
HYPOTHESIS_ID = "HYP-EVENT-DEPTH-TRANSFER-EURUSD-TICK-008"
INPUT_ARTIFACT = {
    "source": "FILE_COMMON",
    "name": "EVENTDEPTHTRANSFER008_SourceLedger.jsonl",
    "sha256": "3B3B0F4CF85FD733B26DE0CA84F890265C94693DC7A58170507491985B2687B8",
}
OVERRIDE_COMMON = (
    "InpDeviationPoints=100;InpEnableAudit=true;"
    "InpHypothesisId=HYP-EVENT-DEPTH-TRANSFER-EURUSD-TICK-008;"
    "InpMagic=8132608;InpMaxLots=1.0;InpResearchAutoMode=true;"
...
def task_packet(role: str) -> dict[str, object]:
    ...
    required = [
        f"EVENTDEPTHTRANSFER008_RunMeta_{role}.json",
        f"EURUSD_EVENTDEPTHTRANSFER008_Trades_{role}.csv",
    ]
    return {
        "schema_version": "event_depth_transfer_008_model0_task.v1",
        "hypothesis_id": HYPOTHESIS_ID,
        "attempt_id": f"EVENTDEPTHTRANSFER008-MODEL0-{role}-001",
...
def main() -> None:
    ...
    shared = [
        ...
        ("frozen_analyzer", RESEARCH / "analyze_event_depth_transfer_008.py"),
