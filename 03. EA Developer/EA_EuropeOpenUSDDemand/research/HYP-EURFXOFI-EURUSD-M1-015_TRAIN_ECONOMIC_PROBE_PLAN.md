# TRAIN ECONOMIC PROBE PLAN - HYP-EURFXOFI-EURUSD-M1-015

Frozen on `2026-07-30` after HYP013 source-quality PASS and before any HYP015 target return is opened. HYP014 was parked before outcome access because its registry state transition was incompatible; HYP015 preserves the exact economic contract and uses the legal `idea -> probe` authority transition. Exact source hashes: feature `EB26ABA7B294BF6F3408D97E9D8B5A1E1ABDD5A5BB5A66842CEEA63E4D7DF13C`, summary `14FAC1FB640D449AA08A93C3603CDDDB46F1DFC81229F0A6EAC6DB2CEC6FFE2C`, artifact manifest `8C008C0C929F6A9BF03248DB9D68C5FF5692D74CEA7B24845E42310C2C0B8258`.

## Mechanism and falsifiable claim

The killed pressure-only parent reversed the broad 07:59-to-14:14 EURUSD move
and achieved gross PF 1.110752 but only PF 0.845237 after 1.50 pips. HYP015 does
...
gate failure kills exactly HYP015; it cannot be rescued by a flow threshold,
