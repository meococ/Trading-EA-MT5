...
SCRIPT = Path(__file__).resolve().parents[1] / "build_eurfxofi_013_source_classifier.py"
SPEC = importlib.util.spec_from_file_location("eurfxofi013", SCRIPT)
...
def _classify(rows: list[dict[str, object]]) -> tuple[dict[str, object], list[str]]:
    ...
    result = MODULE.aggregate_window_frame_013(
