# VALIDATION PROBE PLAN - HYP-EURFXMOM-EURUSD-M1-005

Frozen on `2026-07-30` after HYP-EURFXMOM-EURUSD-M1-004 was parked before
evidence creation or target access because arming canonicalized a duplicate
trailing newline and exposed a base-hash drift. HYP004 opened zero validation or
holdout outcomes. HYP005 uses the same contract on the canonical one-trailing-
newline LF wrapper and changes no trading parameter. Earlier HYP003 was parked before
evidence creation or target access because sentinel arming exposed a wrapper
line-ending base-hash drift. HYP003 opened zero validation or holdout outcomes.
HYP004 uses the same contract on a normalized stable wrapper and changes no
trading parameter. Earlier HYP002 was parked before
authority validation, evidence creation or target access because an armed-state
wrapper test required a pre-outcome structural fix. HYP002 opened zero
validation or holdout outcomes. HYP003 preserves the exact plan, mechanism,
population, entry, exit, costs, gates and charts. Earlier HYP001 was parked before
...
2021-2024 or holdout outcomes; that exact contract was preserved through
HYP002. The economic lineage begins after HYP016 completed its one-shot
2016-2020 TRAIN evaluation. HYP016 killed its final-15-second CME 6E
flow-reversal primary, but
