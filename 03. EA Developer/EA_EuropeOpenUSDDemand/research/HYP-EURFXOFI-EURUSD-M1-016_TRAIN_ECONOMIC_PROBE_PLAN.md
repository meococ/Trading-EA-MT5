# TRAIN ECONOMIC PROBE PLAN - HYP-EURFXOFI-EURUSD-M1-016

Frozen on `2026-07-30` after HYP015 stopped before trade construction or economic metrics. HYP015 measured one target-availability exception: source-valid date `2017-09-28` has neither the frozen 14:14 entry nor 15:59 exit close. HYP016 freezes that exact date as no-trade due unavailable target data; every signal direction, cost, arm and economic gate is unchanged. Validation and holdout remain sealed. Exact source hashes: feature `EB26ABA7B294BF6F3408D97E9D8B5A1E1ABDD5A5BB5A66842CEEA63E4D7DF13C`, summary `14FAC1FB640D449AA08A93C3603CDDDB46F1DFC81229F0A6EAC6DB2CEC6FFE2C`, artifact manifest `8C008C0C929F6A9BF03248DB9D68C5FF5692D74CEA7B24845E42310C2C0B8258`.

## Mechanism and falsifiable claim

The killed pressure-only parent reversed the broad 07:59-to-14:14 EURUSD move
and achieved gross PF 1.110752 but only PF 0.845237 after 1.50 pips. HYP016 does
...
- Maximum one trade per selected weekday; no stop, target or trailing logic in this probe.
- Exact target-unavailable allowlist: `2017-09-28` only. It contributes no trade and cannot be imputed. Any different or additional missing target date is fatal. The selected-date ledger remains 630; economic cadence uses the realized eligible trade count over all elapsed calendar weeks.
...
gate failure kills exactly HYP016; it cannot be rescued by a flow threshold,
