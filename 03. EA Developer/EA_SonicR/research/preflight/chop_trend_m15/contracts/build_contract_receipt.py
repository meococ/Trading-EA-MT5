#!/usr/bin/env python3
"""Build ContractReceipt for HYP-CHOP-TREND-M15-001 and print SHA256."""
...
STUBS = CONTRACTS / "receipt_stubs_HYP_CHOP_TREND_M15_001"
...
PREREG_MD = (
    ...
    / "research"
    / "preregs"
    / "20260714_H_CHOP_TREND_M15_001_PREREG.md"
)
RECEIPT = CONTRACTS / "20260714_HYP_CHOP_TREND_M15_001_CONTRACT_RECEIPT.json"

HYP = "HYP-CHOP-TREND-M15-001"
...
def nogit_snapshot() -> tuple[str, str]:
    # Must match Get-NoGitProvenanceSnapshot with ActiveSource=EA
    paths = [
        ROOT / "AGENTS.md",
...
def main() -> int:
    ...
    stubs = {
        "task_packet.json": {
            ...
            "model": MODEL,
            "run_role": "control",
            "note": "First Model 0 screen under Owner autonomous-MT GOAL; cost not broker-verified.",
        },
        "prereg.json": {
    ...
    receipt = {
        ...
        "note": (
            "Model 0 control screen for chop-trend M15. "
    ...
    (CONTRACTS / "20260714_HYP_CHOP_TREND_M15_001_CONTRACT_RECEIPT.sha256.txt").write_text(
        receipt_sha + "\n", encoding="utf-8"
    )
