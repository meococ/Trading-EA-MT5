...
HYP-PORTFOLIO-COMPOSE-001 attach (not PF-ranked after Spark+ITSM fail):
  - EA_SilverBullet / 20260714_002505  (HYP-SB-WEEKEND-FLAT-001 challenger A1)
...
SB_DIR = ROOT / "02. AlphaFactory" / "runs" / "EA_SilverBullet" / "20260714_002505"
...
OUT_JSON = (
    ...
    / "research"
    / "preflight"
    / "20260714_OFFLINE_SB_SPARK_COMPOSE_PROBE_V1.json"
)
...
def main() -> int:
    ...
    result = {
        "probe_id": "OFFLINE_SB_SPARK_COMPOSE_PROBE_V1",
