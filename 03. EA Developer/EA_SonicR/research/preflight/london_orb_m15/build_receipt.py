# -*- coding: utf-8 -*-
"""Build contract receipt + stubs for HYP-LONDON-ORB-M15-001."""
...
EA = ROOT / "03. EA Developer" / "EA_M15LondonORB" / "EA_M15LondonORB.mq5"
OUT_DIR = (
    ROOT
    / "03. EA Developer"
    / "EA_SonicR"
...
STUB = OUT_DIR / "receipt_stubs_HYP_LONDON_ORB_M15_001"
RECEIPT = OUT_DIR / "20260714_HYP_LONDON_ORB_M15_001_CONTRACT_RECEIPT.json"
...
def main() -> int:
    ...
    overrides = ""  # defaults frozen in EA / prereg; no CLI overrides
    task = {
        "hypothesis_id": "HYP-LONDON-ORB-M15-001",
        "ea_name": "EA_M15LondonORB",
        "symbol": "USDJPY",
        "period": "M15",
        "from": "2021.01.01",
        "to": "2025.12.31",
    ...
    prereg = {
        "hypothesis_id": "HYP-LONDON-ORB-M15-001",
        "prereg_path": "03. EA Developer/EA_SonicR/research/preregs/20260714_H_LONDON_ORB_M15_001_PREREG.md",
        "frozen": True,
    }
    cost = {
    ...
    include_note = (
        "Packet-bound include closure note for HYP-LONDON-ORB-M15-001. "
    ...
    receipt = {
        ...
        "note": "Model 0 London ORB after dual-filter shelf EMPTY; independent of Spark/HourOpen.",
    }
    RECEIPT.write_text(json.dumps(receipt, indent=2) + "\n", encoding="utf-8")
    rec_sha = sha256_file(RECEIPT)
    (OUT_DIR / "20260714_HYP_LONDON_ORB_M15_001_CONTRACT_RECEIPT.sha256.txt").write_text(
        rec_sha + "\n", encoding="utf-8"
    )
