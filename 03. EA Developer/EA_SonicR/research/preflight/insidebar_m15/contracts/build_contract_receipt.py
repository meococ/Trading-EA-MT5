#!/usr/bin/env python3
"""Build ContractReceipt for HYP-INSIDEBAR-M15-001 and print SHA256."""
...
STUBS = CONTRACTS / "receipt_stubs_HYP_INSIDEBAR_M15_001"
...
PREREG_MD = (
    ...
    / "research"
    / "preregs"
    / "20260714_H_INSIDEBAR_M15_001_PREREG.md"
)
RECEIPT = CONTRACTS / "20260714_HYP_INSIDEBAR_M15_001_CONTRACT_RECEIPT.json"
SHA_TXT = CONTRACTS / "20260714_HYP_INSIDEBAR_M15_001_CONTRACT_RECEIPT.sha256.txt"

HYP = "HYP-INSIDEBAR-M15-001"
...
def main() -> int:
    ...
    stubs = {
        "task_packet.json": {
            ...
            "run_role": "control",
            "note": (
                "Independent InsideBar M15 Model 0 after SB weekend-flat park. "
                "Cost = tester current spread only; not FivePercentOnline-Real."
            ),
        },
        "prereg.json": {
    ...
    receipt = {
        ...
        "note": (
            "Model 0 control screen for InsideBar M15 GOAL transfer. "
