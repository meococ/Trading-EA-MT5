#!/usr/bin/env python3
"""Build ContractReceipt for HYP-CADENCE-BOOK-M15-001 and print SHA256."""
...
STUBS = CONTRACTS / "receipt_stubs_HYP_CADENCE_BOOK_M15_001"
EA = ROOT / "03. EA Developer" / "EA_M15HourOpenBreak" / "EA_M15HourOpenBreak.mq5"
PREREG_MD = (
    ROOT
    / "03. EA Developer"
    / "EA_SonicR"
    / "research"
    / "preregs"
    / "20260713_H_CADENCE_BOOK_M15_001_PREREG.md"
)
RECEIPT = CONTRACTS / "20260713_HYP_CADENCE_BOOK_M15_001_CONTRACT_RECEIPT.json"

HYP = "HYP-CADENCE-BOOK-M15-001"
EA_NAME = "EA_M15HourOpenBreak"
FROM = "2021.01.01"
TO = "2025.12.31"
SYMBOL = "EURUSD"
PERIOD = "M15"
...
def main() -> int:
    ...
    include.write_text(
        "EA_M15HourOpenBreak is single-file; Trade.mqh is MT5 standard library. "
    ...
    receipt = {
        ...
        "note": (
            "Model 0 control screen for cadence-book M15 hour-open break. "
