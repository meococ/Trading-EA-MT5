...
EA = ROOT / "03. EA Developer/EA_D1TrendH1PB/EA_D1TrendH1PB.mq5"
OUT = ROOT / "03. EA Developer/EA_SonicR/research/preflight/d1_trend_h1_pb/contracts"
STUB = OUT / "receipt_stubs_HYP_D1_TREND_H1_PB_001"
RECEIPT = OUT / "20260714_HYP_D1_TREND_H1_PB_001_CONTRACT_RECEIPT.json"
HYP = "HYP-D1-TREND-H1-PB-001"
...
def main() -> int:
    ...
    prereg = {
        "hypothesis_id": HYP,
        "prereg_path": "03. EA Developer/EA_SonicR/research/preregs/20260714_H_D1_TREND_H1_PB_001_PREREG.md",
        "frozen": True,
    }
    cost = {
    ...
    include_note = "Trade.mqh stdlib only for HYP-D1-TREND-H1-PB-001."
    ...
    receipt = {
        ...
        "note": "Post-Wave5 path B; D1 EMA50 + H1 EMA21 PB reclaim RR=2.5; distinct from parked H4 sibling.",
    }
    RECEIPT.write_text(json.dumps(receipt, indent=2) + "\n", encoding="utf-8")
    rec_sha = sha256_file(RECEIPT)
    (OUT / "20260714_HYP_D1_TREND_H1_PB_001_CONTRACT_RECEIPT.sha256.txt").write_text(
        rec_sha + "\n", encoding="utf-8"
    )
    print(json.dumps({"sha256": rec_sha, "commit": commit, "receipt": str(RECEIPT)}, indent=2))
    return 0
