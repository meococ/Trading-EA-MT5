#!/usr/bin/env python3
"""Build ContractReceipt for HYP-VOLEXP-M15-001 and print SHA256."""
...
STUBS = CONTRACTS / "receipt_stubs_HYP_VOLEXP_M15_001"
...
RECEIPT = CONTRACTS / "20260713_HYP_VOLEXP_M15_001_CONTRACT_RECEIPT.json"
SHA_TXT = CONTRACTS / "20260713_HYP_VOLEXP_M15_001_CONTRACT_RECEIPT.sha256.txt"

HYP = "HYP-VOLEXP-M15-001"
...
def nogit_snapshot() -> tuple[str, str]:
    # Must match Get-NoGitProvenanceSnapshot in alpha.ps1 (active EA = VolExpansion).
    paths = [
        ROOT / "AGENTS.md",
...
def main() -> int:
    ...
    stubs = {
        "task_packet.json": {
            ...
            "run_role": "control",
            "note": (
                "First Model 0 screen under Owner MT-open (2026-07-14). "
    ...
    receipt = {
        ...
        "note": (
            "Model 0 control screen for RV vol-expansion M15. "
