# TRAIN ECONOMIC PROBE PLAN — HYP-LOFIX-USDJPY-M1-001

Status: **FROZEN 2026-07-29 before any 15:30-16:00 London target return was
read or computed for this object.** This document is immutable after its SHA-256
...
- Hypothesis: `HYP-LOFIX-USDJPY-M1-001`
...
- LOFIX001 tests only the pre-fix last half-hour where the cited literature and
...
- Trial universe for DSR: four x1-cost arms—LOJM001 primary and locked reverse,
  plus LOFIX001 primary and locked reverse. Cost tiers are not extra trials.
...
- Attempt: `LOFIX001-TRAIN-ECON-001`, exactly once.
- Evidence root: `03. EA Developer/EA_LondonFixHalfHourMomentum/research/evidence/HYP-LOFIX-USDJPY-M1-001/LOFIX001-TRAIN-ECON-001/`.
