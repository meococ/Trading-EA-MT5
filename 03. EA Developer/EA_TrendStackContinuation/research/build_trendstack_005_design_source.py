"""Build a sealed, outcome-blind DESIGN H1 source from narrow capabilities."""
...
PROJECTION_RECEIPT_SCHEMA = "trendstack_005_design_projection_receipt.v1"
    ...
    *,
    ...
    try:
        ...
        request_rows = [
            {
                ...
                "request_id": "HYP005::" + day + "::H1_SOURCE",
                "schema_version": "trendstack_005_design_request.v1",
        ...
        request_receipt = {
            ...
            "schema_version": "trendstack_005_design_request_receipt.v1",
        }
        ...
        for index, day in enumerate(dates):
            ...
            relative = Path("raw_h1") / "DESIGN" / day / "1201_1800.parquet"
            ...
            trace_rows.append(
                {
                    ...
                    "request_index": index,
                    "rows": table.num_rows,
                    "schema_version": "trendstack_005_design_source_trace.v1",
                }
            )
        ...
        _exclusive_write(attempt / "design_h1_manifest.jsonl", manifest_payload)
        ...
        reconciliation = {
            ...
            "h1_rows": total_rows,
            "schema_version": "trendstack_005_design_source_reconciliation.v1",
        ...
        receipt: dict[str, object] = {
            ...
            "schema_version": "trendstack_005_design_source_receipt.v1",
        ...
        _exclusive_write(attempt / "design_h1_source_receipt.json", receipt_payload)
