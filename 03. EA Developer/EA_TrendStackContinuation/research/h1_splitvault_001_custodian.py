...
def _validate_authority(authority: CustodyAuthority) -> None:
    ...
    if (
        ...
        or not authority.source_attempt_id.startswith("HYP005-SOURCE-ATTEMPT-")
        or len(authority.source_attempt_id) != len("HYP005-SOURCE-ATTEMPT-") + 16
...
def run_custody(
    ...
    try:
        ...
        private_receipt = {
            ...
            "schema_version": "h1_splitvault_001_private_custody_receipt.v1",
