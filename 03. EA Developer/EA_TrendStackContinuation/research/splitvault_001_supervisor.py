...
RUN_PACKET_SCHEMA = "trendstack_003_splitvault_source_run_packet.v1"
COLLECTION_ID = "DATASET-FIVEPERCENT-EURUSD-M1-SPLITVAULT-001"
HYPOTHESIS_ID = "HYP-TRENDSTACK-EURUSD-H1-003"
RUN_PACKET_VERDICT = "FROZEN_OUTCOME_BLIND_SOURCE_RUN_AUTHORIZED"
RUN_PACKET_FILENAME = "HYP-TRENDSTACK-EURUSD-H1-003_SOURCE_RUN_PACKET.json"
REVIEWED_RUN_PACKET_SHA256: str | None = None

COLLECTION_PLAN_SHA256 = "673D285C8C46D81C2D21ED0BD1E46D12A0EB12CD7DF874074909EF1FA5D2BF2B"
HYPOTHESIS_PLAN_SHA256 = "6A2165CDCE80AD4B04036832C1685746B3828452A8223F35B448DC0568091475"
HYPOTHESIS_PLAN_V2_SHA256 = "13BCD3AEB5AB08EC060EAF5107A384FEE8A2CAF581506B50C5F0D8C5A5830840"
HYPOTHESIS_PLAN_V2_FILENAME = "HYP-TRENDSTACK-EURUSD-H1-003_PROBE_PLAN_V2.md"
HYPOTHESIS_PLAN_V3_SHA256 = "1323330E76ED3671D5B57A367A4A84A6944B01634A4E90EC1B53128DFBB68649"
HYPOTHESIS_PLAN_V3_FILENAME = "HYP-TRENDSTACK-EURUSD-H1-003_PROBE_PLAN_V3.md"
HYPOTHESIS_PLAN_V4_SHA256 = "7CB8B477C261451E9EA27F16959C0C6B416D8DF4354598BFFCB98C952B34E7F8"
HYPOTHESIS_PLAN_V4_FILENAME = "HYP-TRENDSTACK-EURUSD-H1-003_PROBE_PLAN_V4.md"
...
SOURCE_ATTEMPT_PREFIX = "HYP003-SOURCE-ATTEMPT-"
AUTHORITY_SENTINEL_LINE = b"REVIEWED_RUN_PACKET_SHA256: str | None = " + b"None"
ATTEMPT_EVIDENCE_PARENT = "HYP-TRENDSTACK-EURUSD-H1-003_SOURCE_ATTEMPTS"
...
_PENDING_TREE_SCHEMA = "trendstack_003_pending_tree.v1"
_PENDING_BASE_FILES = {
...
_FILE_BINDINGS = {
    ...
    "hypothesis_plan_v2_path": "hypothesis_plan_v2_sha256",
    "hypothesis_plan_v3_path": "hypothesis_plan_v3_sha256",
    "hypothesis_plan_v4_path": "hypothesis_plan_v4_sha256",
...
def _create_attempt_started(
    ...
    marker = {
        ...
        "hypothesis_plan_v2_sha256": packet["hypothesis_plan_v2_sha256"],
        "hypothesis_plan_v3_sha256": packet["hypothesis_plan_v3_sha256"],
        "hypothesis_plan_v4_sha256": packet["hypothesis_plan_v4_sha256"],
        ...
        "schema_version": "trendstack_003_source_attempt_started.v1",
...
def _create_attempt_terminal(
    ...
    terminal = {
        **evidence,
        ...
        "packet_sha256": packet_sha256,
        "runtime_supervisor_sha256": runtime_supervisor_sha256,
        "schema_version": "trendstack_003_source_attempt_terminal.v1",
        "source_attempt_id": packet["source_attempt_id"],
        "supervisor_review_base_sha256": packet["supervisor_review_base_sha256"],
        "verdict": verdict,
    }
...
def _validate_registry_authority(payload: bytes, packet: dict[str, object]) -> None:
    ...
    if _digest(raw_row) != REGISTRY_ROW_SHA256:
        raise ValueError
    ...
    for index, line in enumerate(lines, start=1):
        ...
        if value.get("hypothesis_id") == HYPOTHESIS_ID:
            latest_hyp003 = index
    if latest_hyp003 != REGISTRY_ROW_INDEX:
        raise ValueError
    ...
    if (
        ...
        != "03. EA Developer/EA_TrendStackContinuation/research/HYP-TRENDSTACK-EURUSD-H1-003_PROBE_PLAN.md"
        or row.get("prereg_sha256") != HYPOTHESIS_PLAN_SHA256
        or type(reason) is not str
        or "only after independent review plus a create-new hash-bound run packet" not in reason
        or "exactly one outcome-blind custody and DESIGN source-completeness attempt" not in reason
...
def _validate_paths(packet: dict[str, object]) -> None:
    ...
    if len({str(path).lower() for path in inputs}) != len(inputs):
        raise ValueError
    if (
        Path(str(packet["hypothesis_plan_v2_path"])).name != HYPOTHESIS_PLAN_V2_FILENAME
        or Path(str(packet["hypothesis_plan_v3_path"])).name != HYPOTHESIS_PLAN_V3_FILENAME
        or Path(str(packet["hypothesis_plan_v4_path"])).name != HYPOTHESIS_PLAN_V4_FILENAME
...
def _expected_attempt_paths(packet: dict[str, object]) -> dict[str, Path]:
    ...
    research = Path(str(packet["hypothesis_plan_v3_path"])).absolute().parent
...
def _production_expected_paths(source_attempt_id: str) -> dict[str, Path]:
    ...
    paths = {
        "collection_plan_path": research / "DATASET-FIVEPERCENT-EURUSD-M1-SPLITVAULT-001_PLAN.md",
        "hypothesis_plan_path": research / "HYP-TRENDSTACK-EURUSD-H1-003_PROBE_PLAN.md",
        "hypothesis_plan_v2_path": research / HYPOTHESIS_PLAN_V2_FILENAME,
        "hypothesis_plan_v3_path": research / HYPOTHESIS_PLAN_V3_FILENAME,
        "hypothesis_plan_v4_path": research / HYPOTHESIS_PLAN_V4_FILENAME,
        ...
        "custodian_tool_path": research / "splitvault_001_custodian.py",
        "supervisor_tool_path": research / "splitvault_001_supervisor.py",
        "design_builder_tool_path": research / "build_trendstack_003_design_source.py",
        "validator_tool_path": research / "validate_trendstack_003_design_source.py",
        "custodian_test_path": package / "tests" / "test_splitvault_001_custodian.py",
        "supervisor_test_path": package / "tests" / "test_splitvault_001_supervisor.py",
        "design_builder_test_path": package / "tests" / "test_build_trendstack_003_design_source.py",
        "validator_test_path": package / "tests" / "test_validate_trendstack_003_design_source.py",
        "splitvault_output_root": workspace / "02. AlphaFactory" / "data" / "fivepercent" / "EURUSD" / "splitvault_001",
        "design_source_output_root": workspace / "02. AlphaFactory" / "data" / "fivepercent" / "EURUSD" / "trendstack_003_design_m1",
    }
...
def _production_frozen(packet_path: Path) -> FrozenBindings:
    ...
    expected_external = {
        ...
        "hypothesis_plan_v2_sha256": HYPOTHESIS_PLAN_V2_SHA256,
        "hypothesis_plan_v3_sha256": HYPOTHESIS_PLAN_V3_SHA256,
        "hypothesis_plan_v4_sha256": HYPOTHESIS_PLAN_V4_SHA256,
