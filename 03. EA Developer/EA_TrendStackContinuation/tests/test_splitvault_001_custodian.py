...
TOOL_PATH = ROOT / "research" / "splitvault_001_custodian.py"
SOURCE_ATTEMPT_ID = "HYP003-SOURCE-ATTEMPT-0123456789ABCDEF"


def load_tool():
    spec = importlib.util.spec_from_file_location("splitvault_001_custodian_test", TOOL_PATH)
...
def write_fixture(tmp_path: Path, rows: list[dict[str, object]] | None = None):
    ...
    authority = tool.CustodyAuthority(
        ...
        source_footer_sha256=tool.parquet_footer_sha256(source),
