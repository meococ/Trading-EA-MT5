...
input string InpHypothesisId        = "HYP-STBS-XAUUSD-M15-026";
input string InpVariantTag          = "STBS_H1_FLIP_M15_BURST_TRADE_V13_POSTCLAIM_RECONCILE";
input bool   InpAuditOnly           = false;
input bool   InpEnableTelemetry     = true;
input long   InpMagic               = 5604126;
...
const string EA_NAME              = "EA_SupertrendBurstScalperTradeV13";
