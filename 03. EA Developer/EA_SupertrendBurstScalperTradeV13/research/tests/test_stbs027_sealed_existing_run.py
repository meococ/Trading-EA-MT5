...
MODULE_PATH = Path(__file__).resolve().parents[1] / "compare_stbs027_sealed_existing_run.py"
SPEC = importlib.util.spec_from_file_location("stbs027", MODULE_PATH)
    ...
    validation.update(
        {
            ...
            "parent_task_packet_sha256": M.PARENT_TASK_SHA,
