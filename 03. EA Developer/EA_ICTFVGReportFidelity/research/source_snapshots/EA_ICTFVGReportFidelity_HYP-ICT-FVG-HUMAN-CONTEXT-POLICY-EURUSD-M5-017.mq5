...
const string HYPOTHESIS_ID="HYP-ICT-FVG-HUMAN-CONTEXT-POLICY-EURUSD-M5-017";
...
bool WriteRunMeta()
  {
   ...
   string payload=StringFormat(
      ...
      g_human_context_invalid,g_human_policy_rejections);
...
bool OpenLifecycleTelemetry()
  {
   ...
   return OpenHumanContextTelemetry() && WriteRunMeta();
  }
