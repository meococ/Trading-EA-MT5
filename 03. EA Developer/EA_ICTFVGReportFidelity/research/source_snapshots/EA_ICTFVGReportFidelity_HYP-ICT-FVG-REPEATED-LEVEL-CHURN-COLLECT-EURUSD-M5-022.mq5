...
const string HYPOTHESIS_ID="HYP-ICT-FVG-REPEATED-LEVEL-CHURN-COLLECT-EURUSD-M5-022";
...
bool OpenLifecycleTelemetry()
  {
   ...
   return OpenHumanContextTelemetry() && OpenTickInitiationTelemetry() &&
          OpenLevelPathTelemetry() && WriteRunMeta();
  }
