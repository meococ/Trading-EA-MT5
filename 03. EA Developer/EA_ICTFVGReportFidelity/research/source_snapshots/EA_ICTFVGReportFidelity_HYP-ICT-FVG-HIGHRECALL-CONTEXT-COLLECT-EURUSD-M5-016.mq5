...
const string HYPOTHESIS_ID="HYP-ICT-FVG-HIGHRECALL-CONTEXT-COLLECT-EURUSD-M5-016";
const string TELEMETRY_PROFILE="lifecycle-v3+human-context-v1";
...
void LogHumanContextDecision(const int direction,
  ...
  {
   if(!InpEnableTelemetry || g_human_context_handle==INVALID_HANDLE)
      return;
   MqlTick tick;
   if(!SymbolInfoTick(_Symbol,tick))
     {
