#!/usr/bin/env python3
"""Build hash-bound AlphaFactory receipts for HYP-009 full-chart no-account-DD diagnostic Model 0.
...
HYPOTHESIS_ID = "HYP-ICT-FVG-FULLCHART-NODD-EURUSD-M5-009"
PARENT_HYPOTHESIS_ID = "HYP-ICT-FVG-FIDM0EXEC-EURUSD-M5-008"
...
OUT = ROOT / "02. AlphaFactory" / "runtime" / "ict_fvg_fullchart_nodd_receipts"
PRESETS = {
    "control": PACKAGE / "presets" / "EURUSD_M5_CONTROL_FULLCHART_NODD.set",
    "challenger": PACKAGE / "presets" / "EURUSD_M5_CHALLENGER_FULLCHART_NODD.set",
}
EXPECTED_PRESET_SHA256 = {
    "control": "AD20D9B41A0A66B0EFF3839B4C7E3B372D61164800C7ED08BBCC956855B255EF",
    "challenger": "A03AAD24CE50A90B9C3440BF82F3537C6FEBEF17FA38762D386692FC861E6616",
}
...
def build(role: str, control_run: Path | None) -> tuple[Path, str, str]:
    ...
    task_packet: dict[str, object] = {
        ...
        "authority": "OWNER_REQUESTED_FULLCHART_NODD_DIAGNOSTIC_MODEL0",
        "ea_name": EA_NAME,
        "symbol": "EURUSD",
        "period": "M5",
        "from": "2019.01.01",
