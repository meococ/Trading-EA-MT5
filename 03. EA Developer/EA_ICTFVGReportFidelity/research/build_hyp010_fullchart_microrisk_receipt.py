#!/usr/bin/env python3
"""Build hash-bound AlphaFactory receipts for HYP-010 identity-bound full-chart micro-risk diagnostic Model 0.
...
HYPOTHESIS_ID = "HYP-ICT-FVG-FULLCHART-MICRORISK-EURUSD-M5-010"
PARENT_HYPOTHESIS_ID = "HYP-ICT-FVG-FULLCHART-NODD-EURUSD-M5-009"
FROM_DATE = "2019.01.01"
TO_DATE = "2022.12.31"
AUTHORITY = "OWNER_REQUESTED_IDENTITY_BOUND_FULLCHART_MICRORISK_DIAGNOSTIC_MODEL0"
TASK_NOTE = (
    "Exactly one frozen full-chart micro-risk control arm; no optimization, "
    "economic comparison, paper/live authority, or holdout access."
)
EA_NAME = "EA_ICTFVGReportFidelity"
PACKAGE = ROOT / "03. EA Developer" / EA_NAME
SOURCE = PACKAGE / f"{EA_NAME}.mq5"
PREREG = PACKAGE / "research" / f"{HYPOTHESIS_ID}_DIAGNOSTIC_PLAN.md"
CAPABILITY = PACKAGE / "ALPHAFACTORY_EA_CONTRACT.json"
NEWS_INCLUDE = PACKAGE / "NewsCalendar2019_2022.mqh"
REGISTRY = ROOT / "04. Memory" / "research" / "CANDIDATE_REGISTRY.jsonl"
OUT = ROOT / "02. AlphaFactory" / "runtime" / "ict_fvg_fullchart_microrisk_receipts"
PRESETS = {
    "control": PACKAGE / "presets" / "EURUSD_M5_CONTROL_FULLCHART_MICRORISK.set",
}
EXPECTED_PRESET_SHA256 = {
    "control": "DD00FEBEC100D40B3B148A2AB4804A7696700B3A95F1FA46EE6587DF92E7CCAC",
}
...
def main() -> int:
    ...
    parser.add_argument("role", choices=("control",))
