#!/usr/bin/env python3
"""Outcome-blind parser for the single frozen HYP-024 collection run."""
...
EXPECTED_SOURCE_SHA256 = "3BC2130CE8F84AF44C6D3EFEC0639A7B461907A096A6AE90636479E6BB40E77B"
EXPECTED_RECEIPT_SHA256 = "C9E1C59FF6B3A3D16B546A03362936F2CC6D3D8723704FFF88C04FB4EBF59073"
...
BUILD_RECEIPT = PACKAGE / "research" / "evidence" / "20260719_HYP024_BUILD_TEST_RECEIPT.json"
...
def analyze_core(run_dir: Path) -> dict:
    ...
    gates = {
        "engineering": {
            "pass": build.get("tests_passed") == 91
    ...
    return {
        "schema_version": "alphafactory_hyp024_collection_result.v1",
        ...
        "gates": gates,
        "limitations": [
            "Quote-mid dwell is a broker-feed path proxy, not signed transaction flow or depth.",
...
def build_result(run_dir: Path) -> dict:
    ...
    first["verdict"] = (
        "PASS_OPEN_SEPARATE_PRE_ECONOMIC_HYP025"
        if all_pass
        else "KILL_AT_HYP024_COLLECTION_DATA_DENSITY_OR_REDUNDANCY"
    )
