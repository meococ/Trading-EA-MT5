...
$package = Join-Path $repo '03. EA Developer\EA_VRAS_RegimeAdaptiveScalperV3'
$preflight = Join-Path $package 'research\preflight\HYP-VRAS-EURUSD-M5-003'
$taskPath = Join-Path $preflight 'task_packet.control.json'
$receiptPath = Join-Path $preflight 'contract_receipt.control.json'
$sourcePath = Join-Path $package 'EA_VRAS_RegimeAdaptiveScalperV3.mq5'
$includePath = Join-Path $package 'NewsCalendar2019_2022.mqh'
$preregPath = Join-Path $package 'research\HYP-VRAS-EURUSD-M5-003_FROZEN_PREREG.md'
...
$registryRow = @($registryLines | Where-Object { $_ -match '"hypothesis_id":"HYP-VRAS-EURUSD-M5-003"' } | Select-Object -Last 1)
...
$task = [ordered]@{
    ...
    source_path = '03. EA Developer/EA_VRAS_RegimeAdaptiveScalperV3/EA_VRAS_RegimeAdaptiveScalperV3.mq5'
    ...
    prereg_path = '03. EA Developer/EA_VRAS_RegimeAdaptiveScalperV3/research/HYP-VRAS-EURUSD-M5-003_FROZEN_PREREG.md'
    prereg_sha256 = Get-FileSha256 $preregPath
    ea_contract_path = '03. EA Developer/EA_VRAS_RegimeAdaptiveScalperV3/ALPHAFACTORY_EA_CONTRACT.json'
