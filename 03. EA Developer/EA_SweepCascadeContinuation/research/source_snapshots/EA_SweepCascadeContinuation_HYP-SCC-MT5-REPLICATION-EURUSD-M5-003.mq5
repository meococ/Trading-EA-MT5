...
input string InpHypothesisId="HYP-SCC-MT5-REPLICATION-EURUSD-M5-003";
input string InpVariantTag="CONTROL_FIRST_CLOSE_BREAK";
input bool   InpUseHoldRetest=false;
input long   InpMagic=5600753;
...
const string PREREG_SHA256="BDF19994229DA9BE07FCF20D9A6670223A727D78C17A68D9DB970109245FE88C";
...
bool ValidateInputs()
  {
   ...
   if(!InpResearchAutoMode || !InpEnableTelemetry ||
      InpHypothesisId!="HYP-SCC-MT5-REPLICATION-EURUSD-M5-003" ||
      InpMagic!=5600753)
      return false;
   if(InpUseHoldRetest)
     {
