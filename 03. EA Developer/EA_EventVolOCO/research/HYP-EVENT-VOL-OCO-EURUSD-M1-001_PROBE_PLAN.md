# HYP-EVENT-VOL-OCO-EURUSD-M1-001 — Frozen Probe Plan

Status: `FROZEN_BEFORE_SOURCE_FEASIBILITY_RUN`  
...
- Trials = 2; Model 0 is reserved for later economics.
...
| One exact source-feasibility run | yes |
