#!/usr/bin/env python3
"""Build the guarded HYP-LASR-EURUSD-M5-001 Model-0 task packet."""
...
HYPOTHESIS_ID = "HYP-LASR-EURUSD-M5-001"
...
OVERRIDES = (
    ...
    "InpHypothesisId=HYP-LASR-EURUSD-M5-001;"
    ...
    "InpMagic=5603102;InpMaxAccountDrawdownPct=8.0;"
    ...
    "InpVariantTag=LASR_EUR_SWEEP_MODEL0;InpVolumeLookback=20;"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=(
            ...
            "HYP-LASR-EURUSD-M5-001/task_packet.control.json"
        ),
    )
