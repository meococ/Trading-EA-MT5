...
Only one `DATA_ACQUISITION_ONLY_NO_MODEL0_PERFORMANCE` attempt is permitted. Claim-before-read, attempt receipt and COMPLETE/FAILED terminal are required. Same-ID retry, strategy execution, costs, validation, holdout, optimization, paper, live and promotion are forbidden.
