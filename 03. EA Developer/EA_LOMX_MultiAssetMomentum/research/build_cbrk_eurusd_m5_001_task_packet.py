#!/usr/bin/env python3
"""Build the guarded HYP-CBRK-EURUSD-M5-001 Model-0 task packet."""
...
OVERRIDES = (
    ...
    "InpEnableTelemetry=true;InpEngineMode=1;InpFridayFlattenMinutesUtc=1200;"
    "InpHypothesisId=HYP-CBRK-EURUSD-M5-001;"
    ...
    "InpMagic=5603201;InpMaxAccountDrawdownPct=8.0;"
    ...
    "InpVariantTag=CBRK_EUR_BREAKOUT_MODEL0;InpVolumeLookback=20;"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=(
            ...
            "HYP-CBRK-EURUSD-M5-001/task_packet.control.json"
        ),
    )
