#!/usr/bin/env python3
"""Build the guarded HYP-LASR-EURUSD-M5-003 Model-0 task packet."""
...
OVERRIDES = (
    ...
    "InpHypothesisId=HYP-LASR-EURUSD-M5-003;"
    ...
    "InpMagic=5603104;InpMaxAccountDrawdownPct=8.0;"
    ...
    "InpVariantTag=LASR_EUR_SWEEP_ACCOUNTSAFE_MODEL0;InpVolumeLookback=20;"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=(
            ...
            "HYP-LASR-EURUSD-M5-003/task_packet.control.json"
        ),
    )
