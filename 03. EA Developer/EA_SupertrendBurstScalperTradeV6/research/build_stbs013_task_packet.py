...
HYPOTHESIS_ID = "HYP-STBS-XAUUSD-M15-019"
EA_NAME = "EA_SupertrendBurstScalperTradeV6"
...
EXPECTED_SOURCE_SHA256 = "067633008AC0B88E56B15825DFA5226822D25C2B6E49AAC62AFFA6732D89F477"
EXPECTED_PREREG_SHA256 = "BA98ACC7B5F1A204AD366A4DDCB0588A0214D0FA6B0272D2AA90946474806A5E"
EXPECTED_CONTRACT_SHA256 = "891E6636F45B263F6163F5E703C9E87B912846B114CE25D5E45517871FD28057"
EXPECTED_COST_SHA256 = "D822F04B6C7E92F8242BD66037CF28D6E7DCCD121FE6E46B98427D5FF22AC4B6"
EXPECTED_REGISTRY_ROW_SHA256 = "89B2734185631841D01809F7C12F19F1F0BFD138EDB0B9025E31A99D9A20F2AD"
OVERRIDES = (
    "InpAuditOnly=false;InpEnableTelemetry=true;"
    "InpHypothesisId=HYP-STBS-XAUUSD-M15-019;InpMagic=5604119;"
...
def latest_registry_identity() -> tuple[str, dict]:
    ...
    if row.get("hypothesis_id") != HYPOTHESIS_ID or row.get("state") != "screened":
        raise RuntimeError("latest registry row is not the frozen HYP019 screened authority")
    if row_hash != EXPECTED_REGISTRY_ROW_SHA256:
        raise RuntimeError(f"HYP019 authority row drift: {row_hash}")
    return row_hash, row
...
def main() -> None:
    ...
    packet = {
        ...
        "fixed_delay_ms": 0,
        "timeout_sec": 900,
        "attempt_id": "STBS019-MODEL0-TRAIN-001",
        "attempt_limit": 1,
        "overrides": OVERRIDES,
