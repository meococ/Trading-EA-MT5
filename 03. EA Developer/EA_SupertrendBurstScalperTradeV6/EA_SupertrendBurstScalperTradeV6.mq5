...
#property description "H1 Supertrend flip trade baseline with account-safe margin and lifecycle-v3 evidence."

input string InpHypothesisId        = "HYP-STBS-XAUUSD-M15-019";
input string InpVariantTag          = "STBS_H1_FLIP_M15_BURST_TRADE_V6_ACCOUNT_SAFE";
input bool   InpAuditOnly           = false;
input bool   InpEnableTelemetry     = true;
input long   InpMagic               = 5604119;
...
const string EA_NAME              = "EA_SupertrendBurstScalperTradeV6";
...
int OnInit()
{
   if(!MQLInfoInteger(MQL_TESTER) || MQLInfoInteger(MQL_OPTIMIZATION) ||
      _Symbol!="XAUUSD" || _Period!=PERIOD_M15 ||
       InpHypothesisId!="HYP-STBS-XAUUSD-M15-019" ||
       InpVariantTag!="STBS_H1_FLIP_M15_BURST_TRADE_V6_ACCOUNT_SAFE" ||
       InpAuditOnly || !InpEnableTelemetry || InpMagic!=5604119 ||
