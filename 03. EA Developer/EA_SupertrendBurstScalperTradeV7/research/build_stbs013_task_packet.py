...
HYPOTHESIS_ID = "HYP-STBS-XAUUSD-M15-020"
EA_NAME = "EA_SupertrendBurstScalperTradeV7"
...
EXPECTED_SOURCE_SHA256 = "B49D1CA7868B723C10B12A23D2C07CA1DF5F2A0BB86B0860C05FD34CE0F03750"
EXPECTED_PREREG_SHA256 = "D0924D29E68525788DA6316EA85EFAF0CD4C0580296E7DBED7288AADAD4CD86A"
EXPECTED_CONTRACT_SHA256 = "891E6636F45B263F6163F5E703C9E87B912846B114CE25D5E45517871FD28057"
EXPECTED_COST_SHA256 = "14BA26C7C7140EEEFBD6046DB9C22F6DBB9181922233DC7AADADD379AF29A2C0"
EXPECTED_REGISTRY_ROW_SHA256 = "3407A524BE60E8FA93ADFE21C0B62972469C1BBED5A981FF5060E8106EA4AF53"
OVERRIDES = (
    "InpAuditOnly=false;InpEnableTelemetry=true;"
    "InpHypothesisId=HYP-STBS-XAUUSD-M15-020;InpMagic=5604120;"
...
def latest_registry_identity() -> tuple[str, dict]:
    ...
    if row.get("hypothesis_id") != HYPOTHESIS_ID or row.get("state") != "screened":
        raise RuntimeError("latest registry row is not the frozen HYP020 screened authority")
    if row_hash != EXPECTED_REGISTRY_ROW_SHA256:
        raise RuntimeError(f"HYP020 authority row drift: {row_hash}")
    return row_hash, row
...
def main() -> None:
    ...
    packet = {
        ...
        "fixed_delay_ms": 0,
        "timeout_sec": 900,
        "attempt_id": "STBS020-MODEL0-TRAIN-001",
        "attempt_limit": 1,
        "overrides": OVERRIDES,
