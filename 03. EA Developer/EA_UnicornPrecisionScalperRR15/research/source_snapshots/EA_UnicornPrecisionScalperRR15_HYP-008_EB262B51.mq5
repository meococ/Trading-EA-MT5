...
const string EA_NAME="EA_UnicornPrecisionScalperRR15";
const string HYPOTHESIS_ID="HYP-UPS-XAU-M5-008";
...
bool ValidateInputs()
  {
   ...
   if(InpRiskPercent<=0.0 || InpRiskPercent>1.0 || InpTargetRR<1.0 || InpBreakEvenR<=0.0)
      return false;
   ...
   if(is_open)
     {
      ...
      if(g_position_identifier!=0 && g_position_identifier!=position_id)
        {
