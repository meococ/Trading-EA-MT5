#!/usr/bin/env python3
"""Build HYP-003 packets through the reviewed T2 D0 packet builder."""
...
def main() -> int:
    spec = importlib.util.spec_from_file_location("t2_d0_packet_builder_v2", BUILDER)
    ...
    builder.PREFLIGHT = (
        PACKAGE / "research" / "preflight" / "HYP-PTR-T2-DATA-EPOCH-D0-M5-003"
    )
    builder.SOURCE = PACKAGE / "EA_PTR_T2_DataEpochD0V3.mq5"
    builder.PREREG = PACKAGE / "research" / "HYP-PTR-T2-DATA-EPOCH-D0-M5-003_PREREG.md"
    builder.EA_CONTRACT = PACKAGE / "ALPHAFACTORY_EA_CONTRACT.json"
    builder.COST = PACKAGE / "research" / "COLLECTION_ONLY_COST_SOURCE_MANIFEST.json"
    builder.HYPOTHESIS_ID = "HYP-PTR-T2-DATA-EPOCH-D0-M5-003"
