...
SOURCE = ROOT / "EA_PTR_T2_DataEpochD0V3.mq5"
...
EXPECTED_EPOCH_SHA = "AEBB0EC6AEBEBE5D0ECA81FC42CB1765CF67835BA1FC134D12827E7B87C3A43E"
...
def test_series_proof_uses_required_mql5_core_calls() -> None:
    ...
    for needle in required:
        assert needle in text
    assert "copytime_first_epoch!=m5_first_epoch" in text
    assert "const datetime copytime_from=(datetime)0;" not in text
