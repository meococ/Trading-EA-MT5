...
input string                InpHypothesisId="HYP-VRAS-EURUSD-M5-002";
input string                InpVariantTag="PRIMARY_TICK_LONDON";
input long                  InpMagic=5600742;
...
const string EA_NAME="EA_VRAS_RegimeAdaptiveScalperV2";
...
bool ValidateInputs()
  {
   if(_Symbol!="EURUSD" || _Period!=PERIOD_M5)
      return false;
   if(InpHypothesisId!="HYP-VRAS-EURUSD-M5-001" || InpMagic!=5600741)
      return false;
