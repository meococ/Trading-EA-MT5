# Logic-to-code matrix - HYP-VRAS-EURUSD-M5-002

HYP-002 keeps the exact HYP-001 signal/risk surface. The only behavioral
revision is the mechanical `OrderCheck()` API correction documented in the
HYP-001 invalid-engineering readout; no threshold or filter was changed.
