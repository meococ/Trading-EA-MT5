# HYP-STC-EURUSD-M15-002 source-to-spec matrix
...
| Fixed-origin recurrence | require exact `2015.01.02 09:00` through `2015.12.31 20:00` native-M15 population of `24,776` copied bars, then one update per completed bar; no premature synchronization sample | origin proof plus seed/window drift regression test |
