...
PACKAGE = ROOT / "03. EA Developer" / "EA_SchaffTrendCycleV2"
SOURCE = PACKAGE / "EA_SchaffTrendCycleV2.mq5"
CONTRACT = PACKAGE / "ALPHAFACTORY_EA_CONTRACT.json"
PREREG = PACKAGE / "research" / "HYP-STC-EURUSD-M15-002_FROZEN_PREREG.md"
COMPILE_LOG = PACKAGE / "EA_SchaffTrendCycleV2.log"
EX5 = PACKAGE / "EA_SchaffTrendCycleV2.ex5"
...
class StcContractTests(unittest.TestCase):
    def test_identity_and_single_indicator_mechanism(self):
        text = source()
        self.assertIn('EXPECTED_HYPOTHESIS="HYP-STC-EURUSD-M15-002"', text)
        self.assertIn('EXPECTED_VARIANT="STC_CLASSIC_TREND_CYCLE_V2_PRELOAD_READY"', text)
