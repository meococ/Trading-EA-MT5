...
input string InpHypothesisId        = "HYP-STBS-XAUUSD-M15-024";
input string InpVariantTag          = "STBS_H1_FLIP_M15_BURST_TRADE_V11_COMPACT_MARGIN_TELEMETRY";
input bool   InpAuditOnly           = false;
input bool   InpEnableTelemetry     = true;
input long   InpMagic               = 5604124;
...
const string EA_NAME              = "EA_SupertrendBurstScalperTradeV11";
