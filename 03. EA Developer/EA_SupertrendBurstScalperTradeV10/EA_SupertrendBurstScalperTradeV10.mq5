...
input string InpHypothesisId        = "HYP-STBS-XAUUSD-M15-023";
input string InpVariantTag          = "STBS_H1_FLIP_M15_BURST_TRADE_V10_SL_STRESSED_MARGIN";
input bool   InpAuditOnly           = false;
input bool   InpEnableTelemetry     = true;
input long   InpMagic               = 5604123;
...
const string EA_NAME              = "EA_SupertrendBurstScalperTradeV10";
...
int OnInit()
{
   if(!MQLInfoInteger(MQL_TESTER) || MQLInfoInteger(MQL_OPTIMIZATION) ||
      _Symbol!="XAUUSD" || _Period!=PERIOD_M15 ||
       InpHypothesisId!="HYP-STBS-XAUUSD-M15-023" ||
       InpVariantTag!="STBS_H1_FLIP_M15_BURST_TRADE_V10_SL_STRESSED_MARGIN" ||
       InpAuditOnly || !InpEnableTelemetry || InpMagic!=5604123 ||
