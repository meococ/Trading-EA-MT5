...
$hypothesisId = 'HYP-RSF-EURUSD-M5-ABI-CORRECTED-001'
...
$packet = [ordered]@{
    ...
    run_role = 'control'
    purpose = 'Fresh same-bar Cell16 control after correcting only the QQE positional input-group ABI; no tuning or validation access.'
