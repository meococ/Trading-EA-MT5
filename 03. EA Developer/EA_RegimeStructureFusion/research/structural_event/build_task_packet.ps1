...
$hypothesisId = 'HYP-RSF-EURUSD-M5-STRUCTURAL-EVENT-004'
...
$packet = [ordered]@{
    ...
    run_role = 'control'
    purpose = 'Exactly one development-only Model0 falsification of the fresh closed displacement BOS/MSS then later retest/reclaim mechanism derived from eight preregistered native MT5 paired charts; no tuning, route pruning, validation, or holdout access.'
