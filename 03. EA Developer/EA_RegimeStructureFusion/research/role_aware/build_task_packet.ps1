...
$hypothesisId = 'HYP-RSF-EURUSD-M5-ROLE-AWARE-003'
...
$packet = [ordered]@{
    ...
    run_role = 'control'
    purpose = 'Development-only role-aware causal price-event state machine derived from seven frozen native MT5 loser charts; no route deletion, tuning, validation, or holdout access.'
    ...
    execution_mode = 0
    fixed_delay_ms = 0
    overrides = 'InpEnableTelemetry=true;InpExpectedSymbol=EURUSD;InpHypothesisId=HYP-RSF-EURUSD-M5-ROLE-AWARE-003;InpMagic=5867313;InpManualModeMask=7;InpManualSessionMask=6;InpProfileMode=1;InpResearchAutoMode=true;InpRoleBreakoutInvalidationAtr=0.50;InpRoleBreakoutMaxTriggerExtensionAtr=0.50;InpRoleExpiryBars=12;InpRoleRangeMinTargetR=1.00;InpRoleRetestToleranceAtr=0.20;InpRoleStateMargin=0.10;InpRoleTrendMaxBasisDistanceHalfWidths=0.75;InpUseContextRouter=true;InpUseQqeTiming=true;InpUseRoleAwareSequence=true;InpUseTbStructure=true;InpUseTemporalSequence=false;InpVariantTag=ROLE_AWARE_CAUSAL_V1'
