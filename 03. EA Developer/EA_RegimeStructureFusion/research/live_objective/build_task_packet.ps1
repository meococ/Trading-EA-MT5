...
$hypothesisId = 'HYP-RSF-EURUSD-M5-LIVE-OBJECTIVE-005'
...
$packet = [ordered]@{
    ...
    run_role = 'control'
    purpose = 'Exactly one development-only Model0 falsification of the live opposing-swing objective gate derived from the terminal parent funnel and eight preregistered native MT5 paired charts; no tuning, route pruning, validation, or holdout access.'
