...
bool WriteRunMeta()
  {
   ...
   payload+="\"use_context_router\":"+(InpUseContextRouter ? "true" : "false")+",\"use_tb_structure\":"+(InpUseTbStructure ? "true" : "false")+",\"use_qqe_timing\":"+(InpUseQqeTiming ? "true" : "false")+",\"use_temporal_sequence\":"+(InpUseTemporalSequence ? "true" : "false")+",\"use_role_aware_sequence\":"+(InpUseRoleAwareSequence ? "true" : "false")+",";
...
bool ValidateInputs()
  {
   ...
   if(InpUseTemporalSequence && InpUseRoleAwareSequence) return(false);
...
void OnTick()
  {
   ...
   bool decision_ready=InpUseRoleAwareSequence ? BuildRoleAwareDecision(snapshot,profile,decision) :
