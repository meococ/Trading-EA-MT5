...
double g_structural_objective=0.0; // Zero means no live opposing swing: fixed-R open-air objective.
...
bool BuildStructuralGeometry(const RsfSnapshot &s,const SymbolProfile &profile,
                             const ENUM_RSF_SIGNAL signal,TradeDecision &d)
  {
   ...
   if(g_structural_objective<=0.0 || d.direction*(g_structural_objective-entry)<=0.0)
      g_structural_objective=fixed_target; // no live opposing swing means open air to the frozen R target
...
bool WriteRunMeta()
  {
   ...
   payload+=StringFormat("\"structural_armed\":%I64d,\"structural_retested\":%I64d,\"structural_confirmed\":%I64d,\"structural_expired\":%I64d,\"structural_canceled\":%I64d,\"structural_reject_context\":%I64d,\"structural_reject_runway\":%I64d,",g_structural_armed,g_structural_retested,g_structural_confirmed,g_structural_expired,g_structural_canceled,g_structural_reject_context,g_structural_reject_runway);
...
void OnTick()
  {
   ...
   if(decision_ready && decision.fired) SubmitEntry(decision);
  }
