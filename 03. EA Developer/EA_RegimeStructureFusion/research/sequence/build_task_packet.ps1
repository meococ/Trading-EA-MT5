...
$hypothesisId = 'HYP-RSF-EURUSD-M5-SEQUENCE-002'
...
$packet = [ordered]@{
    ...
    run_role = 'control'
    purpose = 'Development-only temporal arm-wait-confirm mechanism with frozen location/runway geometry; no route deletion, tuning, validation, or holdout access.'
    ...
    execution_mode = 0
    fixed_delay_ms = 0
    overrides = 'InpBreakoutMaxExtensionAtr=0.35;InpEnableTelemetry=true;InpExpectedSymbol=EURUSD;InpHypothesisId=HYP-RSF-EURUSD-M5-SEQUENCE-002;InpMagic=5867312;InpManualModeMask=7;InpManualSessionMask=6;InpMinBandRunwayR=0.75;InpProfileMode=1;InpResearchAutoMode=true;InpSequenceExpiryBars=3;InpSequenceMinConfirmBars=1;InpTrendMaxBasisDistanceHalfWidths=0.75;InpUseContextRouter=true;InpUseQqeTiming=true;InpUseTbStructure=true;InpUseTemporalSequence=true;InpVariantTag=TEMPORAL_SEQUENCE_V1'
