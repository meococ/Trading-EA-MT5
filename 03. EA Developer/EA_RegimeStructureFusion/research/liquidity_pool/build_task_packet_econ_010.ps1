...
$packet = [ordered]@{
    ...
    run_role = 'control'
    purpose = 'Exactly one full-window Model0 economic falsification of the causal unconsumed swing-liquidity pool after its exported-buffer engineering probe passed; no tuning, pruning, validation, or holdout access is allowed.'
