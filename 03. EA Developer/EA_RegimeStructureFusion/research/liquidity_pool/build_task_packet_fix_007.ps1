...
$packet = [ordered]@{
    ...
    run_role = 'control'
    purpose = 'Exactly one development-only Model0 falsification of the causal unconsumed swing-liquidity pool after the preregistered optional-buffer read correction; no strategy parameter changed and no tuning, pruning, validation, or holdout access is allowed.'
