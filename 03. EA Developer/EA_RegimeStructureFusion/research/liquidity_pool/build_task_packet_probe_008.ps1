...
$hypothesisId = 'HYP-RSF-EURUSD-M5-TB-BUFFER-PROBE-008'
...
$packet = [ordered]@{
    ...
    run_role = 'control'
    purpose = 'One short-window Model1 engineering-only buffer fail-code probe. Performance metrics, economic comparison, optimization, validation, holdout and promotion are forbidden.'
