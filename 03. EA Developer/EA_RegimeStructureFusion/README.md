...
- TB SMC public contract buffer 43 must be at least `2.0`.
...
- Engineering: **PASS** — compile 0 errors, 21 targeted structural/temporal
  tests pass, all five indicators initialize, TB v3 buffers 44..47 export a
  causal unconsumed-swing liquidity pool, and EntryContext/Lifecycle telemetry
  reconciles exactly.
- Economic: **FAIL** — `HYP-RSF-EURUSD-M5-LIQUIDITY-POOL-ECON-010` ran one
  frozen EURUSD M5 Model-0 trial over 2018–2022. Its 162 trades produced PF
  0.714519, net -USD 3,981.17 and -0.136032R mean expectancy. Europe and New
  York were both negative.
